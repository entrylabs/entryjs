...
Lang.Menus = {
    ...
    "code_management_1": "엔트리 캠페인 #1",
    "code_management_2": "코드 잘 관리하기",
...
Lang.Workspace = {
    ...
    "my_storage_block_drop": "나의 보관함의 블록을\n조립소에 추가합니다.",
    "my_storage_object_drop": "나의 보관함의 블록을\n조립소에 추가합니다.",
    "my_storage_backpack_drop": "오브젝트를\n나의 보관함에\n추가합니다.",
    "my_storage": "나의 보관함",
    "my_block": "나의 블록"
};
Lang.code = "코드보기";
...
Lang.Helper = {
    ...
    "calc_operation": "입력한 수에 대한 다양한 수학식의 계산값입니다. (제곱, 루트, 사인값, 코사인값, 탄젠트값, 아크사인값, 아크코사인값, 아크탄젠트값, 로그값, 자연로그값, 소수점 부분, 소수점 버림값, 소수점 올림값, 반올림값, 펙토리얼값, 절대값)",
