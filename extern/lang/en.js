...
Lang.Menus = {
    ...
    "solve_mission_desc_2": "Control Entrybot move through the maze so it can reach its destination while learning the concepts of sequence, repeat, select, comparison and function.",
    ...
    "hw_desc_wrapper_1": "엔트리 하드웨어 연결 프로그램과 오프라인 버전이",
    "hw_desc_wrapper_2": "서비스를 한층 더 강화해 업그레이드 되었습니다.",
    "hw_desc_wrapper_3": "업데이트 된 프로그램을 설치해주세요!",
...
Lang.Helper = {
    ...
    "neobot_repeat_while_true": "url(help/neobot_repeat_while_true.html)",
    "neobot_stop_repeat": "url(help/neobot_stop_repeat.html)",
    "neobot_if": "url(help/neobot_if.html)",
    "neobot_if_else": "url(help/neobot_if_else.html)",
    "neobot_wait_until_true": "url(help/neobot_wait_until_true.html)",
    "neobot_stop_object": "url(help/neobot_stop_object.html)",
    "neobot_move_for_secs": "url(help/neobot_move_for_secs.html)",
    "neobot_move_for": "url(help/neobot_move_for.html)",
    "neobot_stop_for": "url(help/neobot_stop_for.html)",
    "neobot_diode_secs_toggle": "url(help/neobot_diode_secs_toggle.html)",
    "neobot_diode_toggle": "url(help/neobot_diode_toggle.html)",
    "neobot_diode_inout_toggle": "url(help/neobot_diode_inout_toggle.html)",
    "neobot_diode_set_output": "url(help/neobot_diode_set_output.html)",
    "neobot_diode_input_value": "url(help/neobot_diode_input_value.html)",
    "neobot_melody_note_for": "url(help/neobot_melody_note_for.html)",
    "neobot_touch_if": "url(help/neobot_touch_if.html)",
    "neobot_touch_if_else": "url(help/neobot_touch_if_else.html)",
    "neobot_touch_value": "url(help/neobot_touch_value.html)",
    "neobot_touch_value_boolean": "url(help/neobot_touch_value_boolean.html)",
    "neobot_light_value_if": "url(help/neobot_light_value_if.html)",
    "neobot_light_value_if_else": "url(help/neobot_light_value_if_else.html)",
    "neobot_light_value": "url(help/neobot_light_value.html)",
    "neobot_light_value_boolean": "url(help/neobot_light_value_boolean.html)",
    "neobot_sound_value_if": "url(help/neobot_sound_value_if.html)",
    "neobot_sound_value_if_else": "url(help/neobot_sound_value_if_else.html)",
    "neobot_sound_value": "url(help/neobot_sound_value.html)",
    "neobot_sound_value_boolean": "url(help/neobot_sound_value_boolean.html)",
    "neobot_irs_value_if": "url(help/neobot_irs_value_if.html)",
    "neobot_irs_value_if_else": "url(help/neobot_irs_value_if_else.html)",
    "neobot_irs_value": "url(help/neobot_irs_value.html)",
    "neobot_irs_value_boolean": "url(help/neobot_irs_value_boolean.html)",
    "neobot_others_value_if": "url(help/neobot_others_value_if.html)",
    "neobot_others_value_if_else": "url(help/neobot_others_value_if_else.html)"
};
Lang.Category = {
