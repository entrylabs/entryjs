...
Lang.Helper = {
    ...
    sound_something_wait_with_block:
        "Plays object's selected sound then the next block runs after the playing finished.",
    sound_something_second_wait_with_block:
        "Plays object's selected sound for input seconds then the next block runs.",
    sound_volume_change:
        'Changes the volume of all the sounds played as much as the input percentage.',
    ...
    set_sound_speed: 'Sets the speed of all sounds played by the object to the input value.',
    ...
    sound_from_to_and_wait:
        "Plays object's selected sound between the input seconds then the next block runs.",
    ...
    speech_to_text_get_value:
        'Reports the value that converted speech to text. If no voice is input or an error occurs during voice recognition, it will have 0 value.',
