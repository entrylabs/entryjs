...
Lang.Blocks = {
    ...
    "behaviorConduct01001002": "Before the typhoon comes",
    "behaviorConduct01001003": "When the typhoon watch occurs",
    "behaviorConduct01001004": "When the typhoon warning occurs",
    "behaviorConduct01001005": "After the typhoon has passed",
    ...
    "behaviorConduct01004002": "Before the gale comes",
    "behaviorConduct01004003": "When the gale occurs",
    "behaviorConduct01004004": "After the winds has passed",
    "behaviorConduct01005002": "When the heavy snow occurs",
    "behaviorConduct01006002": "When the cold wave occurs",
    "behaviorConduct01007002": "Before the storm comes",
    "behaviorConduct01007003": "When the storm warning occurs",
    "behaviorConduct01008002": "When the dust storm forecast occurs",
    "behaviorConduct01008003": "When the dust storm occurs",
    "behaviorConduct01008004": "After the dust storm has passed",
    "behaviorConduct01009001": "Before the heatwave comes",
    "behaviorConduct01009002": "When the heatwave watch occurs",
    "behaviorConduct01009003": "When the heatwave warning occurs",
    "behaviorConduct01010001": "Before the drought comes",
    ...
    "behaviorConduct01014002": "When the landslide warning occurs",
...
Lang.Menus = {
    ...
    "picture_upload_warn_1": "You can only upload jpg, png, bmp files that are less than 10MB.",
    ...
    "esensor_board": "E-Sensorboard",
    "esensor_robot": "E-SensorRobot",
    "hamster": "Hamster",
    ...
    "entry_addr": "Meritz Tower 7/F 382 Connect Foundation , Gangnamgu, Gangnamdaero Seoul ",
...
Lang.Workspace = {
    ...
    "load_exapnsion_block": "Load Exapnsion Block",
...
Lang.Helper = {
    ...
    "stop_object": "All objects : Stops all objects <br> This block : Stop all blocks in this object. <br> This object: Stops all blocks in this object. <br?> This Object's other blocs : Stops blocks not connected to this object's blocks.<br/>Other Object : Stop all blocks in other objects",
    ...
    "sound_from_to": "Plays object’s select sound between the two input numbers of time while next block runs",
    "sound_from_to_and_wait": "Plays object’s select sound between the two input numbers of time then runs next blocks",
    ...
    "check_city_weather": "<br>Checks whether the weather information of the selected date and region matches the actual weather conditions.",
    "check_city_finedust": "<br>Checks whether the current fine dust information of the selected region matches the actual fine dust grade.",
    "get_city_weather_data": "<br>Reports various weather information values (the lowest temperature, the highest temperature, humidity, precipitation, precipitation probability, wind speed) of the selected date and region.",
    "get_current_city_weather_data": "<br>Reports the current weather information (temperature, fine dust grade) of the selected region.",
    "get_today_city_temperature": "<br>Reports the today temperature of selected area and time zone.",
    "count_festival": "<br>The number of events that occur in the selected date and region.",
    "get_festival_info": "<br>Reports the information about events held at the selected date and region.",
    "get_translated_string": "<br>Translate the entered text into the selected language. You can enter up to 20 characters.",
    "check_language": "<br>Detects the language of the input text. You can enter up to 20 characters in sentence form.",
