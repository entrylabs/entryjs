...
Lang.Helper = {
    ...
    "byrobot_dronefighter_controller_controller_light_manual_single_input"		: "<br>조종기 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b11111111), 10진수(255), 16진수(0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    "byrobot_dronefighter_controller_controller_buzzer_scale"					: "<br>지정한 옥타브의 음을 계속해서 연주합니다(최대 60초).<br>이 블럭은 연주 명령을 실행 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font>",
    "byrobot_dronefighter_controller_controller_buzzer_scale_delay"				: "<br>지정한 옥타브의 음을 지정한 시간동안 연주합니다. 이 블럭을 사용하면 소리가 끝날때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font> <font color='blueviolet'>#시간지연</font>",
    "byrobot_dronefighter_controller_controller_buzzer_scale_reserve"			: "<br>지정한 옥타브의 음을 지정한 시간동안 연주하도록 예약합니다. 이 블럭은 소리가 나도록 예약하고 바로 다음 블럭으로 넘어갑니다. 예약은 최대 12개까지 누적할 수 있습니다. 이 블럭은 주로 버저 소리와 함께 다른 행동을 동시에 할 때 사용합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#예약</font>",
    "byrobot_dronefighter_controller_controller_buzzer_hz"						: "<br>지정한 주파수의 소리를 계속해서 연주합니다(최대 60초). 이 블럭은 연주 명령을 실행 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#주파수</font> <font color='darkorange'>#즉시</font>",
    "byrobot_dronefighter_controller_controller_buzzer_hz_delay"				: "<br>지정한 주파수의 소리를 지정한 시간동안 연주합니다. 이 블럭을 사용하면 소리가 끝날때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font> <font color='blueviolet'>#시간지연</font>",
	"byrobot_dronefighter_controller_controller_buzzer_hz_reserve"				: "<br>지정한 주파수의 소리를 지정한 시간동안 연주하도록 예약합니다. 이 블럭은 소리가 나도록 예약하고, 바로 다음 블럭으로 넘어갑니다. 예약은 최대 12개까지 누적할 수 있습니다. 이 블럭은 주로 버저 소리와 함께 다른 행동을 동시에 할 때 사용합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#주파수</font> <font color='darkorange'>#예약</font>",
	...
	"byrobot_dronefighter_controller_controller_vibrator_on_delay"				: "<br>진동을 지정한 시간동안 켭니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='darkorange'>#시간지연</font>",
	...
	"byrobot_dronefighter_controller_controller_vibrator_delay"					: "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 반복합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='darkorange'>#시간지연</font>",	
    ...
    "byrobot_dronefighter_drive_drone_light_manual_single_input"			: "<br>자동차 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b11111111), 10진수(255), 16진수(0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    "byrobot_dronefighter_drive_controller_light_manual_single_input"		: "<br>조종기 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b11111111), 10진수(255), 16진수(0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    "byrobot_dronefighter_drive_controller_buzzer_scale"					: "<br>지정한 옥타브의 음을 계속해서 연주합니다(최대 60초).<br>이 블럭은 연주 명령을 실행 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font>",
    "byrobot_dronefighter_drive_controller_buzzer_scale_delay"				: "<br>지정한 옥타브의 음을 지정한 시간동안 연주합니다. 이 블럭을 사용하면 소리가 끝날때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font> <font color='blueviolet'>#시간지연</font>",
    ...
    "byrobot_dronefighter_drive_controller_buzzer_hz"						: "<br>지정한 주파수의 소리를 계속해서 연주합니다(최대 60초). 이 블럭은 연주 명령을 실행 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#주파수</font> <font color='darkorange'>#즉시</font>",
    "byrobot_dronefighter_drive_controller_buzzer_hz_delay"					: "<br>지정한 주파수의 소리를 지정한 시간동안 연주합니다. 이 블럭을 사용하면 소리가 끝날때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font> <font color='blueviolet'>#시간지연</font>",
	...
	"byrobot_dronefighter_drive_controller_vibrator_on_delay"				: "<br>진동을 지정한 시간동안 켭니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='darkorange'>#시간지연</font>",
	...
	"byrobot_dronefighter_drive_controller_vibrator_delay"					: "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 반복합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='darkorange'>#시간지연</font>",	
	...
	"byrobot_dronefighter_flight_drone_control_coordinate"					: "<br>드론 좌표 기준을 변경합니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#좌표기준</font>",
	"byrobot_dronefighter_flight_drone_control_drone_reset_heading"			: "<br>드론의 방향을 초기화합니다. 앱솔루트 모드인 경우 현재 드론이 바라보는 방향을 0도로 변경합니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#방향초기화</font>",
    ...
    "byrobot_dronefighter_flight_drone_light_manual_single_input"			: "<br>드론 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b11111111), 10진수(255), 16진수(0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    "byrobot_dronefighter_flight_controller_light_manual_single_input"		: "<br>조종기 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b11111111), 10진수(255), 16진수(0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    "byrobot_dronefighter_flight_controller_buzzer_scale"					: "<br>지정한 옥타브의 음을 계속해서 연주합니다(최대 60초).<br>이 블럭은 연주 명령을 실행 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font>",
    "byrobot_dronefighter_flight_controller_buzzer_scale_delay"				: "<br>지정한 옥타브의 음을 지정한 시간동안 연주합니다. 이 블럭을 사용하면 소리가 끝날때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font> <font color='blueviolet'>#시간지연</font>",
    ...
    "byrobot_dronefighter_flight_controller_buzzer_hz"						: "<br>지정한 주파수의 소리를 계속해서 연주합니다(최대 60초). 이 블럭은 연주 명령을 실행 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#주파수</font> <font color='darkorange'>#즉시</font>",
    "byrobot_dronefighter_flight_controller_buzzer_hz_delay"				: "<br>지정한 주파수의 소리를 지정한 시간동안 연주합니다. 이 블럭을 사용하면 소리가 끝날때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='darkorange'>#즉시</font> <font color='blueviolet'>#시간지연</font>",
	...
	"byrobot_dronefighter_flight_controller_vibrator_on_delay"				: "<br>진동을 지정한 시간동안 켭니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='darkorange'>#시간지연</font>",
	...
	"byrobot_dronefighter_flight_controller_vibrator_delay"					: "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 반복합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='darkorange'>#시간지연</font>",	
...
Lang.template = {
    ...
    "albert_set_orientation_on_board": "말판 %1 방향으로 바라보기 %2",
	...
	"byrobot_dronefighter_drive_drone_control_double_one"					: "자동차를 %1 %2% 정하기 %3", 				/* 방향 선택에 ComboBox 사용 */
	"byrobot_dronefighter_drive_drone_control_double_one_delay"				: "자동차를 %1 %2% %3 초 실행 %4", 			/* 방향 선택에 ComboBox 사용 */
    ...
    "byrobot_dronefighter_flight_drone_control_quad_one"					: "드론 %1 %2% 정하기 %3", 					/* 방향 선택에 ComboBox 사용 */
	"byrobot_dronefighter_flight_drone_control_quad_one_delay"				: "드론 %1 %2% %3 초 실행 %4", 				/* 방향 선택에 ComboBox 사용 */
    ...
    "byrobot_dronefighter_flight_controller_light_manual_single"			: "조종기 LED %1 %2 %3",						/* 전체 ComboBox 사용 */
    ...
    "roduino_motor": "%1 %2 %3",
    "roduino_set_color_pin": "컬러센서 R : %1, G : %2, B : %3 번 핀으로 지정하기 %4",
