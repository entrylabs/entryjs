...
Lang.Blocks = {
    ...
    "brightness": "明度",
    "BRUSH": "筆",
    "BRUSH_brush_erase_all": "すべての筆を消す",
    ...
    "JUDGEMENT_is_press_some_key_2": "キーが押されているか?",
    "JUDGEMENT_reach_something_1": "",
    "JUDGEMENT_reach_something_2": "に到着したか?",
    "JUDGEMENT_true": " true",
    "LOOKS": "形状",
    ...
    "LOOKS_change_shape_prev": "前",
    "LOOKS_change_shape_next": "次",
    ...
    "MOVING": "動作",
    "MOVING_bounce_wall": "画面の端に到達した場合弾く",
    ...
    "SOUND_sound_something_second_wait_3": "秒再生して待機",
    "SOUND_sound_something_wait_1": "サウンド",
    "SOUND_sound_something_wait_2": "再生して待機",
    "SOUND_sound_volume_change_1": "ボリュームを",
    "SOUND_sound_volume_change_2": "%に変更",
    "SOUND_sound_volume_set_1": "ボリュームを",
    ...
    "START_mouse_click_cancled": "マウスクリックを解除した時",
    ...
    "START_when_object_click_canceled": "オブジェクトクリックを解除した時",
    ...
    "VARIABLE_combine_something_3": "を合わせる",
    "VARIABLE_get_canvas_input_value": " 回答",
    "VARIABLE_get_variable": "変数",
    "VARIABLE_get_variable_1": "値",
    ...
    "SCENE_start_scene_pre": "前",
    "SCENE_start_scene_next": "次",
    "FUNCTION_explanation_1": "名前",
    "FUNCTION_character_variable": "文字/数字値",
    ...
    "TUT_if_barrier_1": "もしも前に",
    "TUT_if_barrier_2": " があるなら",
    "TUT_if_conical_1": "もしも前に",
    ...
    "BRUSH_change_brush_transparency_2": "%分変更",
    ...
    "SOUND_sound_from_to_and_wait_4": "秒まで再生して待機",
    ...
    "block_hi": "やあ!",
    "entry_bot_name": "エントリーボット",
    "hi_entry": "やあ、エントリー!",
    "hi_entry_en": "Hello Entry!",
    "bark_dog": "犬が吠えるサウンド",
    "walking_entryBot": "エントリーボット_歩行",
    "entry": "エントリー",
    "hello": "やあ",
    "nice": "嬉しいな",
    "silent": "無音",
...
Lang.Menus = {
    ...
    "revokeTitle": "個人情報の復元",
    "revokeDesc1": "1年以上サイトにログインしていないため",
    "revokeDesc2": "お客様の個人情報を分離し、保存しています。",
    "revokeDesc3": "分離し保存しているの個人情報を復元するには",
    "revokeDesc4": "[復元する] ボタンを押してください。",
    "revokeButton": "復元する",
    "revokeComplete": "個人情報の復元が完了しました。",
    "resign": "会員退会",
    ...
    "deleteAccount_2": "会員退会手続きから30日後に会員情報と作品/講義/クラス/投稿/コメント/いいね/お気に入り情報はすべて削除され、復元できなくなります。",
    ...
    "mission_modal_content_success": "制作した作品を実行してみてください。",
    "in_progress": "進行中",
    "completed": "完了",
    "submitted": "提出完了",
    ...
    "file_upload_desc_2": "血が流れる残酷な画像",
    "file_upload_desc_3": "体の部位が露出している煽情的な画像",
    "file_upload_desc_4": "悪口や呪いなど、不快感を与えたり嫌悪感をもたらす画像",
    "file_upload_desc_5": "* 上のような内容は、利用規約および関連法律により制裁を受けることがあります。",
    "picture_upload_warn_1": "10MB以下のjpg, png, bmp形式のファイルを追加できます。",
    "sprite_upload_warn": "You can only upload image or object files such as jpg, png, bmp, eo that are less than 10MB.",
    ...
    "lesson_to_class_2": "課題に追加したい講義をお気に入り講義に登録してください。",
    ...
    "lesson_share_cancel_alert": "作品を非公開にするとお気に入りの数が0になります。続けますか?",
    ...
    "gnb_create_lessons": "オープン講義を作成する",
    ...
    "select_project": "自分の作品またはお気に入り作品を読み込みます。",
    ...
    "more_mission": "もっとたくさんのミッションを確認する",
    ...
    "no_marked_project_1": "お気に入り作品がありません。",
    ...
    "no_marked_lecture_1": "お気に入り講義がありません。",
    ...
    "no_marked_lecture_collect_1": "お気に入り講義集がありません。",
    ...
    "my_lecture": "自分の講義",
    "markedGroup": "クラスのお気に入り",
    "markedGroup_lecture": "クラスのお気に入り講義",
    "markedGroup_curriculum": "クラスのお気に入り講義集",
    "marked_lecture": "お気に入り講義",
    "marked_lecture_collection": "自分のお気に入り講義集",
    "marked_marked_curriculum": "お気に入り講義集",
    ...
    "entry_go_go_desc": "学年別・難易度別に用意された教材をぜひご活用ください！各課程別に教育課程・教材・教師用指導資料の3点セットを提供しております。",
    "stage_beginner": "初級",
    "stage_middle": "中級",
    "stage_high": "高級",
    ...
    "go_left": "  左",
    "go_forward": "前に進む",
    "jr_turn_left": "左にターンする",
    "jr_turn_right": "右にターンする",
    "go_slow": "ゆっくり進む",
    ...
    "eduPlatformTitle": "国内の教育現場に合致する教育プラットフォーム",
    "eduPlatformDesc_1": "国内の教育現場に適合した教育ツールを",
    ...
    "algorithmDesc_1": "ゲーム感覚でミッションを解決し、認定書を手に入れてください。",
    ...
    "noResult": "検索結果がありません。",
    "comment_view": "コメント",
    "upload_project": "アップロードする",
    "edit": "修正",
    "save_complete": "保存",
    "just_like": "いいね!",
    "share": "共有",
    "who_likes_project": "作品にいいね!した人",
    "people_interest": "作品をお気に入りに登録した人",
    "none_person": "なし",
    "inserted_date": "登録日",
    ...
    "study_label_interest": "お気に入り講義",
    "study_label_share": "共有",
    "study_label_like_people": "講座にいいね!した人",
    "study_label_interest_people": "講座をお気に入りに登録した人",
    ...
    "curriculum_lecture_upload": "講義をアップロードする",
    ...
    "curriculum_modal_interest": "お気に入り講義",
    "group_curriculum_modal_curriculums": "自分の講義集",
    "group_curriculum_modal_interest": "お気に入り講義集",
    ...
    "go_further": "さらに進む",
    "marked_project": "お気に入り作品",
    "marked_group_project": "クラスのお気に入り作品",
    "basic": "基本",
    "application": "応用",
    ...
    "maze_5_intro": "すごいね! 今からはリピートブロックともしもブロックを一緒に使ってみよう~。もしもブロックを使うと、前に壁がある時に壁のない方向に回転できるよ。じゃあ、友達を助けに出発しようか?",
    "maze_5_title_1": "もしもブロック",
    "maze_5_content_1": "もしも~ならブロックはどのように動作しますか?",
    "maze_5_detail_1": "「もしも前に{画像}があるなら」ブロックを使うと、前に{画像}がある時にどんな行動をするのか決めることができるよ。<br>前に{画像}がある時だけブロックの中のブロックを実行して、<br>そうでない時は実行しないようになるんだ。",
    ...
    "maze_6_title_1": "もしもブロック",
    "maze_6_content_1": "もしも~ならブロックはどのように動作しますか?",
    "maze_6_detail_1": "「もしも前に{画像}があるなら」ブロックを使うと、前に{画像}がある時にどんな行動をするのか決めることができるよ。<br>前に{画像}がある時だけブロックの中のブロックを実行して、<br>そうでない時は実行しないようになるんだ。",
    ...
    "maze_operation10_1_textset_4": "<span class=\"textMultiline\">前に進み続け、</br><span class=\"textEmphasis\">「もしも壁が出てきたら」</span></br>右側に回転するんだ~!</span>",
    ...
    "maze_operation10_4_textset_2": "<span class=\"textMultiline\">前に進み続け、</br>もしも壁が出てきたら</span>",
    "maze_operation10_4_textset_3": "<span class=\"textMultiline\">前に進み続け、</br>もしも壁が出てきたら</br>右に回転する。</span>",
    ...
    "succeeded_and_cert": "個のブロックだけで成功したよ! <br>認定書をもらいに行こう。",
    ...
    "project_nobody_interest": "「お気に入り作品」を押すと、マイページで閲覧することができます。",
    "lecture_nobody_like": "この講義が気に入ったら、「いいね!」を押してください。",
    "lecture_nobody_interest": "「お気に入り講義」を押すと、マイページで閲覧することができます。",
    "course_nobody_like": "この講義集が気に入ったら、「いいね」を押してください。",
    "course_nobody_interest": "「お気に入り講義集」を押すと、マイページで閲覧することができます。",
    "before_changed": "変更前",
    "after_changed": "変更後",
    ...
    "this_is": "です。",
    "privacy": "プライバシーポリシー",
    "entry_addr": "ソウル市江南区江南大路382 メリッツタワー7階　財団法人コネクト",
    ...
    "jr_whats_ur_name": "あなたの認定証に入る名前は？",
    "jr_down_cert": "認定書を受け取る",
    ...
    "cparty_car_intro_2": "よし! だけど、今度は道がまっすぐじゃないね! 左/右にターンするブロックでうまく運転して、一緒に燃料を手に入れに行こうか?",
    ...
    "cparty_car_intro_5": "わぁ、今度の道路はちょっと複雑そうだけど、前に進むと左/右にターンするブロックを繰り返しながら行けばOKだよ! 落ち着いて燃料のところまで行ってみよう",
    "cparty_car_intro_6": "今度は道路に障害物があるから、うまく回らないといけなさそうだね。もしも障害物が前にあったらどのようにすればいいか教えてね!",
    "cparty_car_intro_7": "うん、うまいね! もう一度もしもブロックを使って障害物を避けながら燃料を手に入れに行こう!",
    "cparty_car_intro_8": "あっ、さっき見かけたスピードバンプが2つもあるよ。ゆっくり進むブロックを利用して安全に燃料を補給しに行こう!",
    "cparty_car_intro_9": "複雑そうな道だけど、前に使ったリピートブロックともしもブロックをうまく利用すれば十分運転できるよ。燃料を補給できるように手伝って!",
    ...
    "offline_desc_1": "エントリーのオフラインバージョンはインターネットに接続されていない状態でも使用できます。",
    ...
    "offline_required_detail": "ハードディスクの空き容量500MB以上、windows7またはMAC OS 10.8以上",
    "offline_notice": "インストールの前にお読みください",
    "offline_notice_1": "1. バージョン",
    "offline_notice_1_1": "にはハードウェア結合プログラムが内蔵されています。",
    ...
    "hardware_title": "エントリーハードウェア結合プログラムをダウンロード",
    "hardware_desc": "エントリーオンラインの「作品を作る」でハードウェアを結合し、エントリーを利用する場合にのみ別途インストールする必要があります。",
    "hardware_release": "ハードウェア結合プログラム変更内容の詳細は、次のアドレスで確認できます。",
    "hardware_window_download": "Windows版ダウンロード",
    "hardware_osx_download": "Mac版ダウンロード",
    ...
    "lms_add_lectures": "講義をアップロードする",
    "lms_add_course": "講義集をアップロードする",
    "lms_add_homework": "課題をアップロードする",
    ...
    "hello_kbs": "ㅋㄷㅋㄷ Coding TV",
    "hello_kbs_sub_1": "Join the 'King of coding game' with",
    "hello_kbs_sub_2": "the game that you made!",
    "kbs_banner_title": "KBS <ㅋㄷㅋㄷ CodingTV> - Yangdding x CodingTV",
    "kbs_banner_subtitle": "King of Coding Game!",
    "kbs_banner_desc1": "Youtube star directly play the game that you made!",
    "kbs_banner_desc2": "The best chance to see your game on air, Create a ",
    "kbs_banner_desc3": "fun game and challenge the 'King of the Coding Game'!",
    "kbs_banner_make": "Create",
    "kbs_banner_link_txt1": "Go to KBS",
    "kbs_banner_link_txt2": "Coding TV",
    ...
    "cparty_index_description_3": "エントリーを通してコーディングミッションにチャレンジし、認定書を受け取ってください。",
    ...
    "maze_text_content_11": "よし、さっきみたいにやってみようか? いつ左にターンするのか教えてほしいな。",
    ...
    "maze_content_10": "今度はもしもブロックというのがあるね! もしもブロックを使っていつ、どの方向に回転するのか教えてね!",
    "maze_content_11": "よし、さっきみたいにやってみようか? いつ左にターンするのか教えてほしいな。",
    ...
    "maze_hints_title_5": "もしもブロック",
    "maze_hints_content_5": "もしも~ならブロックはどのように動作しますか?",
    ...
    "ai_hints_content_3_1": "もしもブロックで石を避けられるように手伝ってください。",
    "ai_hints_title_3_2": "もしもブロック(1)",
    "ai_hints_content_3_2": "もしも~ならブロックはどのように動作しますか?",
    "ai_hints_detail_3_2": "もしも前に~があるなら/そうじゃないならブロックを使うと、自分の目の前に石があるのか確認して違う動きができるよ~。<br>もし自分の目の前に石があるなら「もしも」の下にあるブロックを実行して、石がないなら「そうじゃないなら」の中にあるブロックを実行するんだ。<br>僕の目の前に石がある時とない時でどう動くのかをちゃんと決めてね~",
    ...
    "ai_hints_detail_4_2": "レーダーは、物体と自分が今どれだけ離れているかを教えてくれる機械だよ。<br>もし自分の前に何かがあるなら、前方向レーダーは'1'を表示するよ。<br>それと、レーダーは１人でいる時、もしも&lt;true&gt;なら/そうじゃないならブロック<br>のように使えばとっても強力な道具になるんだ。<br>例えば、僕の前にある物体との距離が1より大きい時は安全に前に行けるけど、そうじゃないなら上と下、どちらかに避けることもできるよね。",
    "ai_hints_title_4_3": "もしもブロック(2)",
    "ai_hints_content_4_3": "もしも<true>ならブロックはどうやって使いますか?",
    "ai_hints_detail_4_3": "もしも&lt;true&gt;なら/ そうじゃないならブロックは&lt;true&gt;の中にある内容が合っていれば、「もしも」の下にあるブロックを実行して、違うなら「そうじゃないなら」の下にあるブロックを実行するんだ。<br>どんな状況で違う動きをしたいのかをよく考えて、&lt;true&gt;の中に適切な判断条件を作成して入れてみてね。<br>判断条件を満たして「もしも」の下にあるブロックを実行すると、「そうじゃないなら」の下にあるブロックは実行されないから覚えておいてね!",
    "ai_hints_content_5_1": "レーダーを活用して石を簡単に避けられるように手伝ってください。",
    "ai_hints_detail_5_1": "レーダーを活用して石を簡単に避けられるように手伝ってください。",
    "ai_hints_title_5_2": "もしもブロック(3)",
    "ai_hints_content_5_2": "もしもブロックが重なっている時はどのように動作しますか?",
    "ai_hints_detail_5_2": "もしも~ / そうじゃないならブロックの中にも、もしも~/そうじゃないならブロックを入れられるよ! こうすれば、様々な状況で自分がどのように行動すればいいか決めることができるんだ。<br>例えば、前に石が道をふさいでいる時とそうでない時の行動を決めると、石がある時の状況でも状況に応じて上と下、どちらに行くのかを選択できるようになるよ",
    ...
    "ai_hints_detail_9_2": "そしてブロックには複数の条件を入れることができるよ。入れたすべての条件がtrueの時だけtrueになって、もしもブロックの中にあるブロックが実行されるよ。1つでもfalseがあるとfalseと認識してその中にあるブロックは実行しないんだ",
    ...
    "group_add_lecture_1": "お気に入り講義がありません。",
    "group_add_lecture_2": "「学習する>オープン講義>講義」でクラスの学習内容に",
    "group_add_lecture_3": "追加したい講義をお気に入り講義に登録してください。",
    ...
    "group_add_course_1": "お気に入り講義集がありません。",
    "group_add_course_2": "「学習する > オープン講義>講義集」でクラスの学習内容に",
    "group_add_course_3": "追加したい講義集をお気に入り講義集に登録してください。",
    ...
    "maze_fail_item_remain": "サリー姫を救出できるようにミネラルを全部集めよう。",
    ...
    "maze_fail_more_move": "目的地に着くにはもっと進まないと!",
    ...
    "maze_fail_fall_hole": "あぁ、穴に落ちちゃったね…",
    ...
    "maze_success_not_essential": "よし! %1個のブロックを使って成功させたね!<br>でもこのブロックを使えばもっと簡単に解決できるよ。もう一度チャレンジしてみない?",
    ...
    "maple_cert_input_title": "あなたの認定証に入る名前は？",
    "maze_distance1": "距離1",
    "maze_distance2": "距離2",
    "maze_distance3": "距離3",
    "ev3": "EV3",
    ...
    "learn_programming_line_mission": "\"LINEレンジャー\"とサリーを救え",
    ...
    "learn_programming_level_advanced": "高級",
    "line_look_for": "サリーを探して",
    "line_look_for_desc_1": "LINEレンジャーの力を一つに合わせて最強ボス・メフィストを倒し、サリーを救ってください!",
    "line_save": "サリーを救え",
    "line_save_desc_1": "メフィストの基地に閉じ込められたサリー。LINEレンジャーが障害物を避けてサリーを探し出せるように手伝ってください!",
    "line_escape": "サリーと脱出する",
    "line_escape_desc_1": "爆破されているメフィストの基地に閉じ込められたサリー。LINEレンジャーが障害物を避けてサリーを探し出せるように手伝ってください!",
    ...
    "search_피지컬": "フィジカル",
    "search_기타": "その他",
    "discuss_write_textarea_placeholer": "内容を入力してください(10000文字以下)",
    "maze_road": "道",
    ...
    "pinkbean_index_content": "退屈に耐えられなかったピンクビーンはメイプルワールドへの冒険に出ることにしました。<br />ピンクビーンと一緒に楽しいメイプルワールドを冒険しながら冒険日記を書いてください。<br />各ステージをクリアしながら自然にソフトウェアについて学ぶことができ、ミッションをすべてクリアすれば認定書ももらえます。",
    "rangers_index_title": "LINEレンジャーと一緒にサリーを救いに出発!",
    "rangers_index_content": "最強ボス・メフィストに連れ去られたサリーを救うためLINEレンジャーが力を一つに合わせます。<br />ソフトウェアの原理を通して障害物を克服し、サリーを救うヒーローになってください。<br />各ステップを経て自然にソフトウェアを学ぶことができ、ミッションを終えると認定書も獲得できます。",
    "rangers_replay_button": "映像をもう一度見る",
    "rangers_start_button": "ミッション開始",
    ...
    "choseok_top_wrapper_panel_des": "ウェブ漫画「ココロの声」がコーディングパーティーのミッションとして登場しました。<br/>漫画の中でジョソクが(じゃんけんゲーム)を作っていく過程に参加し、<br/>ミッションにチャレンジしてみてください。<br/>各ステップをクリアしていくことでソフトウェアについて学ぶことができ、<br/>ミッションを全てクリアすると<br/>認定書と共に自分だけのゲームを手に入れることができます。",
...
Lang.Msgs = {
    ...
    "version_update_msg1": "エントリーオフラインの最新バージョン(%1)を\nご使用いただけます。",
...
Lang.Workspace = {
    ...
    "cannot_edit_click_to_stop": "実行中には修正できません。\nクリックして停止する。",
    ...
    "Variable_used_at_all_objects": "すべてのオブジェクトで使用される変数",
    "Variable_create_cloud": "共有変数として使用 <br>(サーバーに保存されます)",
    "Variable_used_at_special_object": "特定オブジェクトでのみ使用される変数です。",
    "draw_new": "新しく描画",
    "draw_new_ebs": "直接描画",
    "painter_file": "ファイル▼",
    ...
    "list_name": "リスト名",
    "list_used_specific_objects": "特定オブジェクトでのみ使用されるリストです。",
    "List_used_all_objects": "すべてのオブジェクトで使用されるリスト",
    ...
    "List_create_cloud": "共有リストとして使用<br>(サーバーに保存されます)",
    ...
    "workspace_tutorial_popup_desc": "<span class='practical_cource_title'>作品を作る</span>は<br />創造的な作品が制作できるように<br /> 様々なブロック機能を提供しています。",
...
Lang.Helper = {
    ...
    "_if": "もしも判断がtrueの場合、包んであるブロックを実行します。",
    ...
    "text_read": "Reports the content of the textbox or the textbox itself.<br />(If there is a line break in the content, it will be returned as a space.)",
...
Lang.General = {
    ...
    "recent_download": "最新バージョンをダウンロード",
...
Lang.template = {
    ...
    "byrobot_petrone_v2_flight_controller_light_color_rgb_input": "decide the color values of controller LED R %1, G %2, B %3 %4 %5",
    "byrobot_petrone_v2_flight_controller_light_color_rgb_select": "RGB combination examples of controller LED %1 %2 %3",
    ...
    "byrobot_petrone_v2_flight_drone_light_color_rgb_input": "decide the color values of drone %1 LED R %2, G %3, B %4 %5 %6",
    "byrobot_petrone_v2_flight_drone_light_color_rgb_select": "RGB combination examples of drone %1 LED %2 %3 %4",
    ...
    "start_drawing": "描画を開始する %1",
    "stop_drawing": "描画を中断する %1",
    "set_color": "筆の色を%1にする %2",
    "set_random_color": "筆の色をランダムにする %1",
    "change_thickness": "筆の太さを%1分変更%2",
    "set_thickness": "筆の太さを%1にする %2",
    "change_opacity": "筆の不透明度を%1 %分変更 %2",
    "set_opacity": "筆の不透明度を%1 %にする %2",
    "brush_erase_all": "すべての筆を消す%1",
    "brush_stamp": "スタンプを押す %1",
    "change_brush_transparency": "筆の透明度を%1 %分変更 %2",
    ...
    "repeat_inf": "続けて繰り返す %1",
    "stop_repeat": "繰り返しを中断する %1",
    "wait_until_true": "%1になるまで待機 %2",
    "_if": "もしも%1なら %2",
    "if_else": "もしも%1なら %2 %3そうじゃないなら",
    "create_clone": "%1のコピーを作成する %2",
    "delete_clone": "このコピーを削除する %1",
    "when_clone_start": "%1のコピーが最初に作成された時",
    "stop_run": "プログラムを終了する %1",
    "repeat_while_true": "%1 %2  繰り返す %3",
    "stop_object": "%1 コードやめる %2",
    "restart_project": "最初から再実行する %1",
    "remove_all_clones": "すべてのコピーを削除する %1",
    "functionAddButton": "%1",
    "function_field_label": "%1%2",
    "function_field_string": "%1%2",
    "function_field_boolean": "%1%2",
    "function_param_string": "文字/数字値",
    ...
    "dialog": "%1を%2 %3",
    "remove_dialog": "話すを削除 %1",
    "change_to_nth_shape": "%1 模様に変更する %2",
    "change_to_next_shape": "%1 模様に変更する %2",
    "set_effect_volume": "%1 効果を%2だけ加える %3",
    "set_effect": "%1 効果を%2 にする %3",
    "erase_all_effects": "効果をすべて削除する %1",
    "change_scale_percent": "サイズを%1だけ変更%2",
    "set_scale_percent": "サイズを%1 にする %2",
    "change_scale_size": "サイズを%1分変更%2",
    "set_scale_size": "サイズを%1 にする %2",
    "flip_y": "左右の模様を入れ替える %1",
    "flip_x": "上下の模様を入れ替える %1",
    "set_object_order": "%1番目に上げる %2",
    "get_pictures": "%1",
    "change_to_some_shape": "%1 模様に変更する %2",
    ...
    "move_direction": "移動方向に%1だけ動かす %2",
    "move_x": "x座標を%1だけ変更%2",
    "move_y": "y座標を%1だけ変更%2",
    "locate_xy_time": "%1秒間 x: %2 y: %3の位置に移動する %4",
    "rotate_by_angle": "オブジェクトを%1分回転する %2",
    "rotate_by_angle_dropdown": "%1分回転する %2",
    "see_angle": "移動方向を%1にする %2",
    "see_direction": "%1側を見る %2",
    "locate_xy": "x: %1 y: %2 位置に移動する %3",
    "locate_x": "x: %1 位置に移動する %2",
    "locate_y": "y: %1 位置に移動する %2",
    "locate": "%1 位置に移動する %2",
    "move_xy_time": "%1秒間 x: %2 y: %3だけ動かす %4",
    "rotate_by_angle_time": "オブジェクトを%1 秒間%2だけ回転する %3",
    "bounce_wall": "画面の端に到達した場合弾く %1",
    "flip_arrow_horizontal": "矢印方向を左右入れ替える %1",
    "flip_arrow_vertical": "矢印方向を上下入れ替える %1",
    "see_angle_object": "%1方向を向く%2",
    "see_angle_direction": "オブジェクトを%1にする %2",
    "rotate_direction": "移動方向を%1だけ回転する %2",
    "locate_object_time": "%1秒間%2 位置に移動する %3",
    "rotate_absolute": "方向を%1にする %2",
    "rotate_relative": "方向を%1だけ回転する %2",
    "direction_absolute": "移動方向を%1にする %2",
    "direction_relative": "移動方向を%1分回転する %2",
    "move_to_angle": "%1の方向に%2分動かす %3",
    "rotate_by_time": "%1秒間、方向を%2だけ回転する %3",
    "direction_relative_duration": "%1秒間、移動方向 %2だけ回転する %3",
    ...
    "when_scene_start": "%1 シーンが開始したとき",
    "start_scene": "%1 スタート%2",
    "start_neighbor_scene": "%1 シーンスタート%2",
    "sound_something": "サウンド%1 再生する %2",
    "sound_something_second": "サウンド%1 %2秒再生する %3",
    "sound_something_wait": "サウンド%1 再生して待機 %2",
    "sound_something_second_wait": "サウンド%1 %2秒再生して待機 %3",
    "sound_volume_change": "ボリュームを%1 %分変更 %2",
    "sound_volume_set": "ボリュームを%1 %にする %2",
    "sound_silent_all": "すべてのサウンドを止める %1",
    "get_sounds": "%1",
    "sound_something_with_block": "サウンド%1 再生する %2",
    "sound_something_second_with_block": "サウンド%1   %2秒再生する %3",
    "sound_something_wait_with_block": "サウンド %1 再生して待機 %2",
    "sound_something_second_wait_with_block": "サウンド%1   %2 秒再生して待機 %3",
    "sound_from_to": "サウンド%1 %2秒から%3秒まで再生する %4",
    "sound_from_to_and_wait": "サウンド%1 %2秒から%3秒まで再生して待機 %4",
    ...
    "variableAddButton": "%1",
    "listAddButton": "%1",
    "change_variable": "%1に%2だけ加える %3",
    "set_variable": "%1を%2にする %3",
    "show_variable": "変数%1表示 %2",
    "hide_variable": "変数%1非表示 %2",
    "get_variable": "%1 %2",
    "ask_and_wait": "%1を尋ねて回答待機 %2",
    "get_canvas_input_value": "%1",
    "add_value_to_list": "%1の項目を%2に追加する %3",
    "remove_value_from_list": "%1番目の項目を%2 から削除する %3",
    "insert_value_to_list": "%1を%2の%3番目に入れる %4",
    "change_value_list_index": "%1    %2番目の項目を%3に変更する %4",
    "value_of_index_from_list": "%1 %2 %3 %4 %5",
    "length_of_list": "%1 %2 %3",
    "show_list": "リスト%1 表示 %2",
    "hide_list": "リスト%1 非表示 %2",
    "options_for_list": "%1",
    "set_visible_answer": "回答%1 %2",
    ...
    "jr_turn_left": "左にターンする%1",
    "jr_turn_right": "右にターンする%1",
    "jr_go_slow": "ゆっくり進む %1",
    "jr_repeat_until_dest": "%1会うまで繰り返す %2",
    "jr_if_construction": "もしも%1前にあるなら %2",
    "jr_if_speed": "もしも%1前にあるなら %2",
    ...
    "maze_step_if_1": "もしも前に%1があるなら%2",
    "maze_step_if_2": "もしも前に%1があるなら%2",
    "maze_call_function": "約束を読み込む%1",
    "maze_define_function": "約束する%1",
    "maze_step_if_3": "もしも前に%1があるなら%2",
    "maze_step_if_4": "もしも前に%1があるなら%2",
    ...
    "maze_step_if_mushroom": "もしも1マス前に%1があるなら%2",
    "maze_step_if_yeti": "もしも前に%1があるなら%2 %3そうじゃないなら",
    "maze_step_if_left_monster": "もしも左側の攻撃範囲にモンスターがいるなら%1 %2そうじゃないなら",
    "maze_step_if_right_monster": "もしも右側の攻撃範囲にモンスターがいるなら%1 %2そうじゃないなら",
    "maze_step_if_lupin": "もしも2マス前に%1があるなら %2",
    "maze_step_if_else_road": "もしも1マス前に道があるなら %1 %2ないなら",
    "maze_step_if_else_mushroom": "もしも1マス前に%1があるなら%2 %3そうじゃないなら",
    "maze_step_if_else_lupin": "もしも2マス前に%1があるなら%2 %3そうじゃないなら",
    "maze_step_if_else_ladder": "もしも1マス前に%1があるなら%2 %3そうじゃないなら",
    "maze_rotate_left": "左にターンする%1",
    "maze_rotate_right": "右にターンする%1",
    ...
    "maze_iron_switch": "障害物を操る%1",
    "maze_james_heart": "ハートを飛ばす%1",
    "maze_step_if_5": "もしも前に道がないなら%2",
    "maze_step_if_6": "もしも前に%1がないなら%2",
    "maze_step_if_7": "もしも前に%1があるなら%2",
    "maze_step_if_8": "もしも%1なら%2",
    "maze_step_if_else": "もしも%1なら%2 %3そうじゃないなら",
    ...
    "ai_if_else_1": "前に%1があるなら%2 %3そうじゃないなら",
    ...
    "ai_True": "%1",
    "ai_if_else": "もしも%1なら%2 %3そうじゃないなら",
...
Lang.TextCoding = {
    ...
    "alert_function_name_empty_text": "登録された関数のうち関数名にスペース(分かち書き)が含まれる関数がある場合、モード変換できません。",
...
Lang.PythonHelper = {
    ...
    "start_neighbor_scene_elements": "A-- 次の選択肢のうち一つ<br>① 次のシーン: \"next\"または\"次\"<br>② 前のシーン: \"pre\"または\"前\"",
    ...
    "is_clicked_exampleDesc": "[スタート]ボタンをクリックすると、続けてマウスをクリックしたか確認します。もしもマウスをクリックしたら、オブジェクトが\"嬉しいな!\"と0.5秒間話します。",
    ...
    "is_press_some_key_exampleDesc": "[スタート]ボタンをクリックすると、続けて選択したキーを押したか確認します。もしもスペースキーを押したらオブジェクトが移動方向に10移動します。",
    ...
    "boolean_basic_operator_elements": "A, B-- 比較したい数字値<br>① == : AとBの値が同じならTrue、そうじゃないならFalse<br>② > : Aの値がBの値より大きいならtrue、そうじゃないならFalse<br>③ < : Aの値がBの値より小さいならtrue、そうじゃないならFalse<br>④ >= : Aの値がBの値より大きいか同じならtrue、そうじゃないならFalse<br>⑤ <= : Aの値がBの値より小さいか同じならtrue、そうじゃないならFalse",
    "boolean_basic_operator_exampleCode": "def when_start():\n    while True:\n        Entry.add_x(10)\n        if Entry.value_of_object(\"オブジェクト\", \"x\") > 240:\n            Entry.set_x(0)",
    "boolean_basic_operator_exampleDesc": "[スタート]ボタンをクリックすると、続けてオブジェクトx座標を10変更します。もしもオブジェクトx座標が240より大きければオブジェクトx座標を0にします。",
