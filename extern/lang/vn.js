...
Lang.Helper = {
    ...
    "get_translated_string": "<br>입력한 문자값을 선택한 언어로 번역합니다. 입력은 20자까지 가능합니다.<br> *번역 가능한 언어<br> - 한국어 → 영어, 중국어 간체, 중국어 번체, 베트남어, 스페인어, 인도네시아어, 태국어, 프랑스어<br> - 영어 → 일본어, 프랑스어, 한국어<br> - 중국어 간체, 중국어 번체, 베트남어, 스페인어, 인도네시아어, 태국어, 프랑스어 → 한국어<br> - 일본어 →영어<br> - 프랑스어 → 영어",
    "check_language": "<br>입력된 문자값의 언어를 감지합니다. 입력은 문장 형태로 20자까지 가능합니다.",
    "count_disaster_behavior": "<br>선택한 자연재해가 발생했을 때 해야할 행동요령의 수입니다.<br> *옵션<br> 자연재해: 태풍, 홍수, 호우, 강풍, 대설, 한파, 풍랑, 황사, 폭염, 가뭄, 지진, 해일, 산사태<br> 상황: 자연재해에 따라 다름 ",
    "get_disaster_behavior": "<br>선택한 자연재해가 발생했을 때 해야하는 행동요령에 대한 정보입니다.<br> *옵션<br> 자연재해: 태풍, 홍수, 호우, 강풍, 대설, 한파, 풍랑, 황사, 폭염, 가뭄, 지진, 해일, 산사태<br> 상황: 자연재해에 따라 다름",
    "count_lifeSafety_behavior": "<br>선택한 생활 속 문제가 발생했을 때 해야할 행동요령의 수입니다.<br> *옵션<br> 생활 속 문제: 응급처치, 심폐소생술, 소화기·소화전 사용법, 식중독, 산행안전, 실종유괴, 성폭력, 학교폭력, 가정 폭력, 억류 및 납치, 교통사고, 승강기 안전사고, 미세먼지<br> 상황: 생활 속 문제에 따라 다름 ",
    "get_lifeSafety_behavior": "<br>선택한 생활 속 문제가 발생했을 때 해야할 행동요령에 대한 정보입니다.<br> *옵션<br> 생활 속 문제: 응급처치, 심폐소생술, 소화기·소화전 사용법, 식중독, 산행안전, 실종유괴, 성폭력, 학교폭력, 가정 폭력, 억류 및 납치, 교통사고, 승강기 안전사고, 미세먼지<br> 상황: 생활 속 문제에 따라 다름 "
};
Lang.Category = {
