...
Lang.Blocks = {
    ...
    "byrobot_petrone_v2_drone_gyro_roll": "자이로 Roll",
    "byrobot_petrone_v2_drone_gyro_pitch": "자이로 Pitch",
    "byrobot_petrone_v2_drone_gyro_yaw": "자이로 Yaw",
...
Lang.Helper = {
    ...
    "byrobot_petrone_v2_controller_controller_display_draw_string": "<br>조종기 OLED 화면에서 지정한 위치에 문자열을 씁니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>글자 입력은 영문자 알파벳 대문자, 소문자와 숫자, 공백(space), 특수문자만 가능합니다.(한글은 아직 지원되지 않습니다.)<br>x, y 좌표값과 글자 크기, 색을 지정합니다. 시작점 = (x, y), 사용 가능한 값의 범위는 x값은 (0~120), y값과 높이는 (0~60)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
...
Lang.template = {
    ...
    "byrobot_petrone_v2_flight_controller_display_draw_line": "조종기 화면 선 그리기 x1:%1, y1:%2, x2:%3, y2:%4, %5 %6",
    "byrobot_petrone_v2_flight_controller_display_draw_rect": "조종기 화면 사각형 그리기 x:%1, y:%2, 너비:%3, 높이:%4, %5, %6 %7",
