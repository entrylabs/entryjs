...
Lang.Helper = {
    ...
    "byrobot_petrone_v2_drive_drone_value_imu": "<br>페트론V2 IMU센서와 관련된 값들을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#IMU센서</font>",
    "byrobot_petrone_v2_drive_drone_value_sensor": "<br>페트론V2 센서와 관련된 값들을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#센서</font>",
    ...
    "byrobot_petrone_v2_drive_drone_control_double_delay": "<br>자동차 조종 값을 지정합니다. 입력 가능한 값의 범위는 방향 -100 ~ 100, 전진 0 ~ 100입니다. 지정한 시간이 지나면 해당 조종 값을 0으로 변경합니다. 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#조종</font> <font color='forestgreen'>#시간지연</font>",
    ...
    "byrobot_petrone_v2_flight_drone_value_imu": "<br>페트론V2 IMU센서와 관련된 값들을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#IMU센서</font>",
    "byrobot_petrone_v2_flight_drone_value_sensor": "<br>페트론V2 센서와 관련된 값들을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#센서</font>",
...
Lang.template = {
    ...
    "byrobot_petrone_v2_controller_controller_display_clear": "조종기 화면 선택영역 지우기 x:%1, y:%2, 너비:%3, 높이:%4, %5 %6",
    "byrobot_petrone_v2_controller_controller_display_invert": "조종기 화면 선택영역 반전 x:%1, y:%2, 너비:%3, 높이:%4 %5",
    "byrobot_petrone_v2_controller_controller_display_draw_point": "조종기 화면 점 찍기 x:%1, y:%2, %3 %4",
    "byrobot_petrone_v2_controller_controller_display_draw_line": "조종기 화면 선 그리기 x1:%1, y1:%2, x2:%3, y2:%4, %5, %6 %7",
    "byrobot_petrone_v2_controller_controller_display_draw_rect": "조종기 화면 사각형 그리기 x:%1, y:%2, 너비:%3, 높이:%4, %5, %6, %7 %8",
    "byrobot_petrone_v2_controller_controller_display_draw_circle": "조종기 화면 원 그리기 x:%1, y:%2, 반지름:%3, %4, %5, %6",
    "byrobot_petrone_v2_controller_controller_display_draw_string": "조종기 화면 문자열 쓰기 x:%1, y:%2, 글자 크기:%3, %4, 글자 입력:%5, %6",
    "byrobot_petrone_v2_controller_controller_display_draw_string_align": "조종기 화면 문자열 정렬 x1:%1, x2:%2, y:%3, 정렬:%4, 글자 크기:%5, %6, 글자 입력:%7, %8",
    ...
    "byrobot_petrone_v2_drive_drone_control_double_delay": "자동차를 방향 %1%, 전진 %2% %3 초 실행 %4",
    ...
    "byrobot_petrone_v2_drive_controller_display_clear": "조종기 화면 선택영역 지우기 x:%1, y:%2, 너비:%3, 높이:%4, %5 %6",
    "byrobot_petrone_v2_drive_controller_display_invert": "조종기 화면 선택영역 반전 x:%1, y:%2, 너비:%3, 높이:%4 %5",
    "byrobot_petrone_v2_drive_controller_display_draw_point": "조종기 화면 점 찍기 x:%1, y:%2, %3 %4",
    "byrobot_petrone_v2_drive_controller_display_draw_line": "조종기 화면 선 그리기 x1:%1, y1:%2, x2:%3, y2:%4, %5, %6 %7",
    "byrobot_petrone_v2_drive_controller_display_draw_rect": "조종기 화면 사각형 그리기 x:%1, y:%2, 너비:%3, 높이:%4, %5, %6, %7 %8",
    "byrobot_petrone_v2_drive_controller_display_draw_circle": "조종기 화면 원 그리기 x:%1, y:%2, 반지름:%3, %4, %5, %6",
    "byrobot_petrone_v2_drive_controller_display_draw_string": "조종기 화면 문자열 쓰기 x:%1, y:%2, 글자 크기:%3, %4, 글자 입력:%5, %6",
    "byrobot_petrone_v2_drive_controller_display_draw_string_align": "조종기 화면 문자열 정렬 x1:%1, x2:%2, y:%3, 정렬:%4, 글자 크기:%5, %6, 글자 입력:%7, %8",
    ...
    "byrobot_petrone_v2_flight_drone_control_quad_delay": "드론 Roll %1%, Pitch %2%, Yaw %3%, Throttle %4% %5 초 실행 %6",
    ...
    "byrobot_petrone_v2_flight_controller_display_clear": "조종기 화면 선택영역 지우기 x:%1, y:%2, 너비:%3, 높이:%4, %5 %6",
    "byrobot_petrone_v2_flight_controller_display_invert": "조종기 화면 선택영역 반전 x:%1, y:%2, 너비:%3, 높이:%4 %5",
    "byrobot_petrone_v2_flight_controller_display_draw_point": "조종기 화면 점 찍기 x:%1, y:%2, %3 %4",
    "byrobot_petrone_v2_flight_controller_display_draw_line": "조종기 화면 선 그리기 x1:%1, y1:%2, x2:%3, y2:%4, %5, %6 %7",
    "byrobot_petrone_v2_flight_controller_display_draw_rect": "조종기 화면 사각형 그리기 x:%1, y:%2, 너비:%3, 높이:%4, %5, %6, %7 %8",
    "byrobot_petrone_v2_flight_controller_display_draw_circle": "조종기 화면 원 그리기 x:%1, y:%2, 반지름:%3, %4, %5, %6",
    "byrobot_petrone_v2_flight_controller_display_draw_string": "조종기 화면 문자열 쓰기 x:%1, y:%2, 글자 크기:%3, %4, 글자 입력:%5, %6",
    "byrobot_petrone_v2_flight_controller_display_draw_string_align": "조종기 화면 문자열 정렬 x1:%1, x2:%2, y:%3, 정렬:%4, 글자 크기:%5, %6, 글자 입력:%7, %8",
