...
Lang.Helper = {
    ...
    "byrobot_petrone_v2_controller_controller_value_joystick": "<br>조종기의 조이스틱과 관련된 입력 값을 반환합니다. 각 축의 범위는 -100 ~ 100 입니다.<br>조이스틱 방향은 가로x세로 = 3x3 = 총9방향입니다. 위(왼쪽=17, 가운데=18, 오른쪽=20), 중간(왼쪽=33, 센터=34, 오른쪽=36), 아래(왼쪽=65, 가운데=66, 오른쪽=68) 기본값은 센터=34입니다.<br>조이스틱 이벤트는 값이 있을때 2, 없으면 0, 진입 1, 벗어남 3입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
    ...
    "byrobot_petrone_v2_drive_controller_value_joystick": "<br>조종기의 조이스틱과 관련된 입력 값을 반환합니다. 각 축의 범위는 -100 ~ 100 입니다.<br>조이스틱 방향은 가로x세로 = 3x3 = 총9방향입니다. 위(왼쪽=17, 가운데=18, 오른쪽=20), 중간(왼쪽=33, 센터=34, 오른쪽=36), 아래(왼쪽=65, 가운데=66, 오른쪽=68) 기본값은 센터=34입니다.<br>조이스틱 이벤트는 값이 있을때 2, 없으면 0, 진입 1, 벗어남 3입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
    ...
    "byrobot_petrone_v2_flight_controller_value_joystick": "<br>조종기의 조이스틱과 관련된 입력 값을 반환합니다. 각 축의 범위는 -100 ~ 100 입니다.<br>조이스틱 방향은 가로x세로 = 3x3 = 총9방향입니다. 위(왼쪽=17, 가운데=18, 오른쪽=20), 중간(왼쪽=33, 센터=34, 오른쪽=36), 아래(왼쪽=65, 가운데=66, 오른쪽=68) 기본값은 센터=34입니다.<br>조이스틱 이벤트는 값이 있을때 2, 없으면 0, 진입 1, 벗어남 3입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
