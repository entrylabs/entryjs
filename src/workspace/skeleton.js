...
Entry.skeleton.basic_loop = {
    path: function(block) {
        ...
        return ("m -8,0 l 8,8 8,-8 h %cw a 15,15 0 0,1 0,30 H 24 l -8,8 -8,-8 h -0.4 v %ch h 0.4 l 8,8 8,-8 h %crw a 8,8 0 0,1 0,16 H 8 l -8,8 -8,-8 z")
            .replace(/%cw/gi, contentWidth)
            .replace(/%crw/gi, contentWidth - 8)
