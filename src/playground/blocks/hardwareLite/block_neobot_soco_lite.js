...
(function () {
    Entry.NeobotSocoLite = new (class NeobotSocoLite {
        ...
        get monitorTemplate() {
            return {
                imgPath: 'hw/neobot_soco_lite.png',
                width: 700,
                height: 700,
                listPorts: {
            ...
            return {
                ko: {
                    template: {
                        ...
                        // melody
                        neobot_soco_lite_play_note_for: '버저 울리기   옥타브: %2 음: %1 길이: %3 %4',
                        ...
                        neobot_soco_lite_servo_change_degree: '서보모터 각도 바꾸기   %2 %3 %4 %1 %5',
                    },
                    Blocks: {
                        //for dropdown
                ...
                en: {
                    ...
                    template: {
                        // sensor
                        neobot_soco_lite_sensor_value: '%1',
                        neobot_soco_lite_sensor_convert_scale: '%1 \'s changed value   range: %2 ~ %3 conversion: %4 ~ %5',
                        ...
                        neobot_soco_lite_led_brightness_with_sensor: 'Control %2 LED\'s brightness with %1 sensor %3',
                        neobot_soco_lite_color_led_on: 'Turn on the %1 color LED   R %2 G %3 B %4 %5',
                        ...
                        neobot_soco_lite_melody_play_with_sensor: 'Buzzer rings by %1 sensor value %2',
        ...
        getBlocks = function () {
            return {
                ...
                neobot_soco_lite_sensor_convert_scale: {
                    ...
                    func: function(sprite, script) {
                        var port = script.getStringField('PORT');
                        var value = Entry.NeobotSocoLite.localBuffer[port];
                ...
                neobot_soco_lite_decision_equal_with_sensor: {
                    ...
                    func: function(sprite, script) {
                        ...
                        var sensor = Entry.NeobotSocoLite.localBuffer[sensorTemp];
                ...
                neobot_soco_lite_remote_button: {
                    ...
                    func: function(sprite, script) {
                        ...
                        var value = Entry.NeobotSocoLite.localBuffer['IR'];
                        if (key == value) {
                            return true;
                        } else {
                            return false;
                    ...
                    func: function(sprite, script) {
                        if (!script.isStart) {
                            ...
                            setTimeout(function() {
                                ...
                                if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_led_on : 0', 'speak');
                                script.timeFlag = 0;
                            }, durationValue * 1000);
                            return script;
                ...
                neobot_soco_lite_led_brightness_with_sensor: {
                    ...
                    func: function(sprite, script) {
                        ...
                        if (Entry.NeobotSocoLite.log_to_console) {
                            Entry.console.print('=== neobot_soco_lite_led_brightness_with_sensor ===', 'speak');
                            Entry.console.print('out port : ' + outPort, 'speak');
                            Entry.console.print('in port : ' + inPort, 'speak');
                            Entry.console.print('sensor value : ' + Entry.NeobotSocoLite.localBuffer[inPort], 'speak');
                ...
                neobot_soco_lite_color_led_on: {
                    ...
                    func: function(sprite, script) {
                        if (!script.isStart) {
                            ...
                            if (Entry.NeobotSocoLite.log_to_console) {
                                Entry.console.print('=== neobot_soco_lite_color_led_on ===', 'speak');
                                Entry.console.print('port : ' + port, 'speak');
                            ...
                            if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = valRed;
                            if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = valRed;
                            if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = valRed;
                            if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_color_led_on : ' + valRed, 'speak');
                            setTimeout(function() { // set red
                                if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = red;
                                if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = red;
                                if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = red;
                                if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_color_led_on : ' + red, 'speak');
                                setTimeout(function() { // choose green
                                    if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = valGreen;
                                    if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = valGreen;
                                    if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = valGreen;
                                    if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_color_led_on : ' + valGreen, 'speak');
                                    setTimeout(function() { // set green
                                        if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = green;
                                        if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = green;
                                        if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = green;
                                        if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_color_led_on : ' + green, 'speak');
                                        setTimeout(function() { // choose blue
                                            if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = valBlue;
                                            if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = valBlue;
                                            if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = valBlue;
                                            if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_color_led_on : ' + valBlue, 'speak');
                                            setTimeout(function() { // set blue
                                                if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = blue;
                                                if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = blue;
                                                if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = blue;
                                                if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_color_led_on : ' + blue, 'speak');
                                                setTimeout(function() { // accept
                                                    if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = valAccept;
                                                    if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = valAccept;
                                                    if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = valAccept;
                                                    if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_color_led_on : ' + valAccept, 'speak');
                ...
                neobot_soco_lite_motor_start: {
                    ...
                    func: function(sprite, script) {
                        if (!script.isStart) {
                            ...
                            if (Entry.NeobotSocoLite.log_to_console) {
                                Entry.console.print('=== neobot_soco_lite_motor_start ===', 'speak');
                            ...
                            setTimeout(function() {
                                ...
                                if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_motor_start : 0', 'speak');
                                script.timeFlag = 0;
                            }, durationValue * 1000);
                            return script;
                        } else if (script.timeFlag == 1) {
                ...
                neobot_soco_lite_play_note_for: {
                    ...
                    func: function(sprite, script) {
                        if (!script.isStart) {
                            ...
                            if (Entry.NeobotSocoLite.log_to_console) {
                                Entry.console.print('=== neobot_soco_lite_play_note_for ===', 'speak');
                            ...
                            setTimeout(function() {
                                ...
                                if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_play_note_for : 0', 'speak');
                                script.timeFlag = 0;
                            }, 1 / duration * 2000);
                            return script;
                        } else if (script.timeFlag == 1) {
                ...
                neobot_soco_lite_melody_play_with_sensor: {
                    ...
                    func: function(sprite, script) {
                        ...
                        if (Entry.NeobotSocoLite.log_to_console) {
                            Entry.console.print('=== neobot_soco_lite_melody_play_with_sensor ===', 'speak');
                ...
                neobot_soco_lite_servo_init: {
                    ...
                    func: function(sprite, script) {
                        if (!script.isStart) {
                            ...
                            if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = resetValue;
                            if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = resetValue;
                            if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = resetValue;
                            if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_servo_init : ' + resetValue, 'speak');
                            setTimeout(function() {
                                if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = initValue;
                                if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = initValue;
                                if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = initValue;
                                if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_servo_init : ' + initValue, 'speak');
                                setTimeout(function() {
                                    script.timeFlag = 0;
                                }, 100);
                            }, 200);
                ...
                neobot_soco_lite_servo_change_degree: {
                    ...
                    func: function(sprite, script) {
                        if (!script.isStart) {
                            ...
                            if (Entry.NeobotSocoLite.log_to_console) {
                                Entry.console.print('=== neobot_soco_lite_servo_change_degree ===', 'speak');
                                Entry.console.print('port : ' + port, 'speak');
                                Entry.console.print('direction : ' + direction, 'speak');
                                Entry.console.print('speed : ' + speed, 'speak');
                            ...
                            // direction
                            if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = directionValue;
                            if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = directionValue;
                            if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = directionValue;
                            if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_servo_change_degree : ' + directionValue, 'speak');
                            setTimeout(function() { // speed
                                if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = speedValue;
                                if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = speedValue;
                                if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = speedValue;
                                if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_servo_change_degree : ' + speedValue, 'speak');
                                setTimeout(function() { // degree
                                    if (out1) Entry.NeobotSocoLite.remoteBuffer['OUT1'] = degreeValue;
                                    if (out2) Entry.NeobotSocoLite.remoteBuffer['OUT2'] = degreeValue;
                                    if (out3) Entry.NeobotSocoLite.remoteBuffer['OUT3'] = degreeValue;
                                    if (Entry.NeobotSocoLite.log_to_console) Entry.console.print('neobot_soco_lite_servo_change_degree : ' + degreeValue, 'speak');
                                    setTimeout(function() { // final delay
                                        script.timeFlag = 0;
                                    }, 200);
                                }, 200);
