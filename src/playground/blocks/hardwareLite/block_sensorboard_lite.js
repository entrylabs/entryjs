    ...
    Entry.SensorboardLite = new (class SensorboardLite {
        ...
        requestLocalData() {
            ...
            for (var port = 0; port < 12; port++) {
                var value = this.digitalValue[port];
        ...
        getBlocks = function () {
            return {
                ...
                sensorboardlite_is_button_pressed: {
                    ...
                    isNotFor: ['sensorboardLite'],
                    func: function (sprite, script) {
                        return Entry.SensorboardLite.digitalValue[script.getField('PORT', script)];
                    },
                ...
                sensorboardlite_get_digital_value: {
                    ...
                    func(sprite, script) {
                        return Entry.SensorboardLite.digitalValue[
                ...
                sensorboardlite_toggle_pwm: {
                    ...
                    func(sprite, script) {
                        ...
                        Entry.SensorboardLite.digitalValue[port] = value;
                        return script.callReturn();
                    },
                },
                sensorboardlite_convert_scale: {
