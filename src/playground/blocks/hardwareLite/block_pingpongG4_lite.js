...
(function() {
    ...
    Entry.PingpongG4Lite = new (class PingpongG4Lite extends PingpongConnectLite {
        constructor() {
            super(4, 'PingpongG4Lite');
            this.id = '350401';
            this.imageName = 'PingpongG4Lite.png';

            this.blockMenuBlocks = [
                'pingpong_lite_g4_when_button_pressed',
                'pingpong_lite_g4_when_tilted',
                'pingpong_lite_g4_is_button_pressed',
                'pingpong_lite_g4_is_tilted',
                'pingpong_lite_g4_get_tilt_value',
                'pingpong_lite_g4_is_top_shape',
                'pingpong_lite_g4_get_sensor_value',
                'pingpong_lite_g4_multi_motor_rotate',
                'pingpong_lite_g4_motor_rotate',
                'pingpong_lite_g4_start_multi_motor_rotate',
            ...
            return {
                pingpong_lite_g4_when_button_pressed: {
                    ...
                    params: [
                        ...
                        {
                            type: 'Dropdown',
                            options: Lang.Blocks.pingpong_lite_g4_cube_id,
                            value: 0,
                            fontSize: 11,
                    ...
                    def: {
                        params: [null],
                        type: 'pingpong_lite_g4_when_button_pressed',
                    },
                    paramsKeyMap: {
                        CUBEID: 1,
                    },
                ...
                pingpong_lite_g4_when_tilted: {
                    ...
                    def: {
                        params: [null, null],
                        type: 'pingpong_lite_g4_when_tilted',
                    },
                    paramsKeyMap: {
                        CUBEID: 1,
                        TILT_DIR: 2,
                ...
                pingpong_lite_g4_is_button_pressed: {
                    ...
                    def: {
                        params: [null],
                        type: 'pingpong_lite_g4_is_button_pressed',
                    },
                    paramsKeyMap: {
                        CUBEID: 0,
                    },
                ...
                pingpong_lite_g4_is_tilted: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g4_is_tilted' },
                    paramsKeyMap: {
                        CUBEID: 0,
                        TILT_DIR: 1,
                    },
                ...
                pingpong_lite_g4_get_tilt_value: {
                    ...
                    def: {
                        params: [null],
                        type: 'pingpong_lite_g4_get_tilt_value',
                    },
                ...
                pingpong_lite_g4_get_sensor_value: {
                    ...
                    def: { params: [], type: 'pingpong_lite_g4_get_sensor_value' },
                ...
                pingpong_lite_g4_is_top_shape: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g4_is_top_shape' },
                ...
                pingpong_lite_g4_motor_rotate: {
                    ...
                    params: [
                        {
                            type: 'Dropdown',
                            options: Lang.Blocks.pingpong_lite_g4_cube_all,
                            value: 0,
                            fontSize: 11,
                            bgColor: EntryStatic.colorSet.block.darken.HARDWARE,
                            arrowColor: EntryStatic.colorSet.arrow.default.HARDWARE,
                    ...
                    def: {
                        params: [],
                        type: 'pingpong_lite_g4_motor_rotate',
                    },
                ...
                pingpong_lite_g4_start_multi_motor_rotate: {
                    ...
                    def: {
                        params: [],
                        type: 'pingpong_lite_g4_start_multi_motor_rotate',
                    },
                ...
                pingpong_lite_g4_start_motor_rotate: {
                    ...
                    def: {
                        params: [null, null],
                        type: 'pingpong_lite_g4_start_motor_rotate',
                    },
                ...
                pingpong_lite_g4_stop_motor_rotate: {
                    ...
                    def: {
                        params: [],
                        type: 'pingpong_lite_g4_stop_motor_rotate',
                    },
                ...
                pingpong_lite_g4_rotate_servo_mortor: {
                    ...
                    events: {},
                    def: { params: [null, { type: 'angle' }], type: 'pingpong_lite_g4_rotate_servo_mortor' },
                ...
                pingpong_lite_g4_set_dot_pixel: {
                    ...
                    def: {
                        ...
                        type: 'pingpong_lite_g4_set_dot_pixel',
                    },
                ...
                pingpong_lite_g4_set_dot_string: {
                    ...
                    events: {},
                    def: { params: [null, null], type: 'pingpong_lite_g4_set_dot_string' },
                ...
                pingpong_lite_g4_set_dot_clear: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g4_set_dot_clear' },
                ...
                pingpong_lite_g4_playNoteForBeats: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g4_playNoteForBeats' },
                ...
                pingpong_lite_g4_playChordForBeats: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g4_playChordForBeats' },
                    paramsKeyMap: {
                        NOTE_1: 0,
                        NOTE_2: 1,
                        NOTE_3: 2,
                ...
                pingpong_lite_g4_restForBeats: {
                    ...
                    def: { params: [], type: 'pingpong_lite_g4_restForBeats' },
                ...
                pingpong_lite_g4_setTempo: {
                    ...
                    def: { params: [], type: 'pingpong_lite_g4_setTempo' },
                ...
                pingpong_lite_g4_getTempo: {
                    ...
                    skeleton: 'basic_string_field',
                    params: [],
                    def: { params: [], type: 'pingpong_lite_g4_getTempo' },
                    paramsKeyMap: {},
                    class: 'PingpongG4_Music',
                    isNotFor: ['PingpongG4Lite'],
                    func(sprite, script) {
...
module.exports = Entry.PingpongG4Lite;