...
(function() {
    ...
    Entry.PingpongG2Lite = new (class PingpongG2Lite extends PingpongConnectLite {
        constructor() {
            super(2, 'PingpongG2Lite');
            this.id = '350201';
            this.imageName = 'PingpongG2Lite.png';

            this.blockMenuBlocks = [
                'pingpong_lite_g2_when_button_pressed',
                'pingpong_lite_g2_when_tilted',
                'pingpong_lite_g2_is_button_pressed',
                'pingpong_lite_g2_is_tilted',
                'pingpong_lite_g2_get_tilt_value',
                'pingpong_lite_g2_is_top_shape',
                'pingpong_lite_g2_get_sensor_value',
                'pingpong_lite_g2_multi_motor_rotate',
                'pingpong_lite_g2_motor_rotate',
                'pingpong_lite_g2_start_multi_motor_rotate',
                'pingpong_lite_g2_start_motor_rotate',
                'pingpong_lite_g2_stop_motor_rotate',
                'pingpong_lite_g2_rotate_servo_mortor',
                'pingpong_lite_g2_set_dot_pixel',
                'pingpong_lite_g2_set_dot_string',
                'pingpong_lite_g2_set_dot_clear',
                'pingpong_lite_g2_playNoteForBeats',
                'pingpong_lite_g2_playChordForBeats',
                'pingpong_lite_g2_restForBeats',
                'pingpong_lite_g2_setTempo',
                'pingpong_lite_g2_getTempo',
            ];
        }
            ...
            return {
                pingpong_lite_g2_when_button_pressed: {
                    ...
                    params: [
                        ...
                        {
                            type: 'Dropdown',
                            options: Lang.Blocks.pingpong_lite_g2_cube_id,
                            value: 0,
                            fontSize: 11,
                    ...
                    def: {
                        params: [null],
                        type: 'pingpong_lite_g2_when_button_pressed',
                    },
                    paramsKeyMap: {
                        CUBEID: 1,
                    },
                ...
                pingpong_lite_g2_when_tilted: {
                    ...
                    def: {
                        params: [null, null],
                        type: 'pingpong_lite_g2_when_tilted',
                    },
                    paramsKeyMap: {
                        CUBEID: 1,
                        TILT_DIR: 2,
                ...
                pingpong_lite_g2_is_button_pressed: {
                    ...
                    def: {
                        params: [null],
                        type: 'pingpong_lite_g2_is_button_pressed',
                    },
                    paramsKeyMap: {
                        CUBEID: 0,
                    },
                ...
                pingpong_lite_g2_is_tilted: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g2_is_tilted' },
                    paramsKeyMap: {
                        CUBEID: 0,
                        TILT_DIR: 1,
                    },
                ...
                pingpong_lite_g2_get_tilt_value: {
                    ...
                    def: {
                        params: [null],
                        type: 'pingpong_lite_g2_get_tilt_value',
                    },
                ...
                pingpong_lite_g2_get_sensor_value: {
                    ...
                    def: { params: [], type: 'pingpong_lite_g2_get_sensor_value' },
                ...
                pingpong_lite_g2_is_top_shape: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g2_is_top_shape' },
                ...
                pingpong_lite_g2_motor_rotate: {
                    ...
                    params: [
                        {
                            type: 'Dropdown',
                            options: Lang.Blocks.pingpong_lite_g2_cube_all,
                            value: 0,
                            fontSize: 11,
                            bgColor: EntryStatic.colorSet.block.darken.HARDWARE,
                            arrowColor: EntryStatic.colorSet.arrow.default.HARDWARE,
                    ...
                    def: {
                        ...
                        type: 'pingpong_lite_g2_motor_rotate',
                    },
                ...
                pingpong_lite_g2_start_multi_motor_rotate: {
                    ...
                    def: {
                        params: [],
                        type: 'pingpong_lite_g2_start_multi_motor_rotate',
                    },
                ...
                pingpong_lite_g2_start_motor_rotate: {
                    ...
                    def: {
                        params: [null, null],
                        type: 'pingpong_lite_g2_start_motor_rotate',
                    },
                ...
                pingpong_lite_g2_stop_motor_rotate: {
                    ...
                    def: {
                        params: [],
                        type: 'pingpong_lite_g2_stop_motor_rotate',
                    },
                ...
                pingpong_lite_g2_rotate_servo_mortor: {
                    ...
                    events: {},
                    def: { params: [null, { type: 'angle' }], type: 'pingpong_lite_g2_rotate_servo_mortor' },
                ...
                pingpong_lite_g2_set_dot_pixel: {
                    ...
                    def: {
                        params: [null, null, null],
                        type: 'pingpong_lite_g2_set_dot_pixel',
                    },
                ...
                pingpong_lite_g2_set_dot_string: {
                    ...
                    events: {},
                    def: { params: [null, null], type: 'pingpong_lite_g2_set_dot_string' },
                ...
                pingpong_lite_g2_set_dot_clear: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g2_set_dot_clear' },
                ...
                pingpong_lite_g2_playNoteForBeats: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g2_playNoteForBeats' },
                ...
                pingpong_lite_g2_playChordForBeats: {
                    ...
                    events: {},
                    def: { params: [], type: 'pingpong_lite_g2_playChordForBeats' },
                    paramsKeyMap: {
                        NOTE_1: 0,
                        NOTE_2: 1,
                        BEATS: 2,
                    ...
                    func(sprite, script) {
                        return self.postCallReturn(script, () => {
                            console.log('NOTE_1',script.getNumberField('NOTE_1', script));
                            console.log('dfljksadflkdsja',script.getNumberField('dfljksadflkdsja', script));
                ...
                pingpong_lite_g2_restForBeats: {
                    ...
                    def: { params: [], type: 'pingpong_lite_g2_restForBeats' },
                ...
                pingpong_lite_g2_setTempo: {
                    ...
                    def: { params: [], type: 'pingpong_lite_g2_setTempo' },
                ...
                pingpong_lite_g2_getTempo: {
                    ...
                    skeleton: 'basic_string_field',
                    params: [],
                    def: { params: [], type: 'pingpong_lite_g2_getTempo' },
                    paramsKeyMap: {},
                    class: 'PingpongG2_Music',
                    isNotFor: ['PingpongG2Lite'],
                    func(sprite, script) {
