            ...
            return {
                ko: {
                    ...
                    Helper: {
                        ...
                        Cocodron_Dron_Controller_gyroreset: '자이로 초기화  ',
                        Cocodron_Dron_Controller_takeoff: '이륙  ',
                        Cocodron_Dron_Controller_takeoffV2: '이륙 %1 %2 고도설정정',
                        Cocodron_Dron_Controller_land: '착륙  ',
                        Cocodron_Dron_Controller_emergency: '비상정지  ',
                        Cocodron_Dron_Controller_headless: '헤드리스 모드  ',
                        //Cocodron_Dron_Controller_move_drone: '%1 조이스틱을 %2 방향으로 %3 만큼 %4 ms 유지  ',
                        Cocodron_Dron_Controller_altitude: '드론이 상승/ 하강합니다  ',
                        Cocodron_Dron_Controller_rotation: '드론이 회전합니다.  ',
                        Cocodron_Dron_Controller_move_drone_fb: '드론이 앞/뒤로 이동합니다  ',
                        Cocodron_Dron_Controller_move_drone_lr: '드론이 좌/우로 이동합니다  ',
                        Cocodron_Dron_Controller_funled: '4색 LED 색 변경  ',
                        Cocodron_Dron_Controller_flip: '%1 플립  ',
                        Cocodron_Dron_Controller_speed: '속도조정 %1',
                        Cocodron_Dron_Controller_simultaneousOperations: '%1 방향으로 %2 %3 만큼 %4 방향으로 %5 %6 이동  ',
                ...
                en: {
                    template: {
                        ...
                        Cocodron_Dron_Controller_hovering: 'hovering %1 s  ',
                        ...
                        Cocodron_Dron_Controller_takeoff: 'Auto Takeoff ',
                        Cocodron_Dron_Controller_takeoffV2: 'Auto Takeoff %1 %2',
                        Cocodron_Dron_Controller_land: 'Auto Landing ',
                        Cocodron_Dron_Controller_emergency: 'Emergency Stop ',
                        Cocodron_Dron_Controller_headless: 'Headless Mode ',
                        Cocodron_Dron_Controller_altitude: 'Hold left joystick in direction %1 for %2 distance %3ms  ',
                        Cocodron_Dron_Controller_rotation: 'Hold left joystick in direction %1 for %2 distance %3ms  ',
                        Cocodron_Dron_Controller_move_drone_fb: 'Hold right joystick in direction %1 for %2 distances for %3 ms  ',
                        Cocodron_Dron_Controller_move_drone_lr: 'Hold right joystick in direction %1 for %2 distances for %3 ms  ',
                        Cocodron_Dron_Controller_funled: '4-color LED color change  ',
                        Cocodron_Dron_Controller_flip: '%1 flip  ',
                        Cocodron_Dron_Controller_speed: 'Speed adjustment %1',
                        Cocodron_Dron_Controller_simultaneousOperations: '%1 방향으로 %2 %3 만큼 %4 방향으로 %5 %6 이동  ',
