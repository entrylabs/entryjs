      ...
      return {
        ko: {
          template: {
            ...
            microbit2lite_set_servo:
              "핀 %1 에 서보 모터 각도를 %2 로 정하기 %3",
            microbit2lite_set_pwm:
              "핀 %1 에 서보 펄스 폭을 %2 %3초로 정하기 %4",
          ...
          Helper: {
            ...
            microbit2lite_play_preset_music:
              "미리 설정되어 있는 음악을 연주합니다.",
            microbit2lite_play_sound_effect:
              "미리 설정되어 있는 효과음을 연주합니다.",
            microbit2lite_get_btn:
              "선택한 버튼이 눌렸다면 '참'으로 판단합니다.",
        ...
        en: {
          ...
          Helper: {
            ...
            microbit2lite_screen_toggle:
              "Turns on or turns off the LED screen.",
            microbit2lite_set_led:
            ...
            microbit2lite_get_acc:
              "The acceleration value of the selected axis.",
      ...
      return {
        ...
        microbit2lite_show_custom_image: {
          ...
          func: async (sprite, script) => {
            ...
            const parsedPayload = `${processedValue
              .join(":")
              .replace(/,/gi, "")}`;
        ...
        microbit2lite_change_tempo: {
          ...
          func: async (sprite, script) => {
            const beat = Math.round(
              this._clamp(script.getNumberValue("BEAT"), 0, 4)
            );
            const bpm = Math.round(
              this._clamp(script.getNumberValue("BPM"), 1, 230)
            );
