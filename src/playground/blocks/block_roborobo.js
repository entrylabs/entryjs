...
Entry.Roborobo_Roduino = {
    ...
    monitorTemplate: {
        ...
        listPorts: {
            ...
            2: { name: 'D2', type: 'input', pos: { x: 0, y: 0 } },
            3: { name: 'D3', type: 'input', pos: { x: 0, y: 0 } },
            4: { name: 'D4', type: 'input', pos: { x: 0, y: 0 } },
            5: { name: 'D5', type: 'input', pos: { x: 0, y: 0 } },
            6: { name: 'D6', type: 'input', pos: { x: 0, y: 0 } },
            7: { name: 'D7', type: 'input', pos: { x: 0, y: 0 } },
            8: { name: 'D8', type: 'input', pos: { x: 0, y: 0 } },
            9: { name: 'D9', type: 'input', pos: { x: 0, y: 0 } },
            10: { name: 'D10', type: 'input', pos: { x: 0, y: 0 } },
        },
        mode: 'both',
    },
};
...
Entry.Roborobo_SchoolKit = {
    ...
    monitorTemplate: {
        ...
        height: 256,
        listPorts: {
            '0': { name: 'D1', type: 'input', pos: { x: 0, y: 0 } },
            '1': { name: 'D2', type: 'input', pos: { x: 0, y: 0 } },
            '2': { name: 'D3', type: 'input', pos: { x: 0, y: 0 } },
            '3': { name: 'D4', type: 'input', pos: { x: 0, y: 0 } },
            '4': { name: 'D5', type: 'input', pos: { x: 0, y: 0 } },
            '5': { name: 'D6', type: 'input', pos: { x: 0, y: 0 } },
            '6': { name: 'D7', type: 'input', pos: { x: 0, y: 0 } },
        },
        mode: 'both',
    },
};
...
Entry.Roborobo_Roduino.getBlocks = function() {
    return {
        ...
        roduino_on_block: {
            ...
            syntax: { js: [], py: ['Roborobo_roduino.roduino_on_block()'] },
        },
        roduino_off_block: {
            color: '#00979D',
            fontColor: '#fff',
            ...
            syntax: { js: [], py: ['Roborobo_roduino.roduino_off_block()'] },
        },
...
Entry.Roborobo_SchoolKit.getBlocks = function() {
    return {
        ...
        schoolkit_on_block: {
            ...
            syntax: { js: [], py: ['Roborobo_SchoolKit.schoolkit_on_block()'] },
        },
        schoolkit_off_block: {
            color: '#00979D',
            fontColor: '#fff',
        ...
        schoolkit_motor: {
            ...
            syntax: {
                ...
                py: [
                    {
                        syntax:
                            'Roborobo_schoolkit.move_motor_speed(%1, %2, %3)',
                        textParams: [
                            {
                                type: 'Dropdown',
                                options: [
