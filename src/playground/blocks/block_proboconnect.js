...
Entry.ProboConnect = {
    ...
    Color : [/*레드*/[13, 37], /*그린*/[38, 62], /*블루*/[63, 87],
        /*옐로우*/[88, 112], /*블랙*/[113, 137], /*화이트*/[138, 162]],
    ...
    setZero: function () {
        for(var key in this.EdgeFlag)
            this.EdgeFlag[key] = 0;
        for(var key in this.RemoteData)
    ...
    return {
        ...
        connect_infinite_transform_input: {
            ...
            func: function (sprite, script) {
                ...
                switch(select)
                {
                    ...
                    default:
                        return (value - Entry.ProboConnect.Infinite_Start[port]) + (Entry.ProboConnect.Infinite_Count[port] * 255);
                }
            },
        },
        connect_infinite_mm_diameter: {
            ...
            func: function (sprite, script) {
                ...
                return Number(((2 * 3.141592 * (diameter/2)) / 255) * ((value - Entry.ProboConnect.Infinite_Start[port]) + (Entry.ProboConnect.Infinite_Count[port] * 255))).toFixed(3);
            },
        },
        ...
        connect_senser_setting: {
            ...
            params: [
                {
                    type: "Dropdown",
                    options: [
                        ["스위치", "1"], ["적외선", "2"], ["자석", "3"], ["초음파", "4"], ["회전", "5"], ["조도", "6"], ["온도", "7"],
                        ["소리", "8"], ["기울기", "9"], ["압력", "10"], ["심박", "11"], ["컬러", "12"], ["가속도", "13"]
                    ],
                    fontSize: 11,
                    arrowColor: "#FFD974"
                },
            ...
            func: function (sprite, script) {
                ...
                {
                    switch(Aset[i]){
                        case 1: case 2: case 3: value[i] = 1; break;
                        case 4: case 5: case 6: case 7: value[i] = 2; break;
                        case 8: value[i] = 3; break;
                        case 9: value[i] = 4; break;
                        case 10: value[i] = 5; break;
                        case 11: value[i] = 6; break;
                        case 12: value[i] = 7; break;
                        case 13: value[i] = 8; break;
                    }
                }
            ...
            params: [
                {
                    type: "Dropdown",
                    options: [
                        ["[1]도", 1], ["[1]레", 3], ["[1]미", 5],["[1]파", 6], ["[1]솔", 8], ["[1]라", 10], ["[1]시", 12],
                        ["[2]도", 13], ["[2]레", 15], ["[2]미", 17], ["[2]파", 18], ["[2]솔", 20], ["[2]라", 22],  ["[2]시", 24],
                        ["[3]도", 25], ["[3]레", 27], ["[3]미", 29], ["[3]파", 30], ["[3]솔", 32], ["[3]라", 34], ["[3]시", 36],
                        ["[4]도", 37], ["[4]레", 39], ["[4]미", 41], ["[4]파", 42], ["[4]솔", 44], ["[4]라", 46], ["[4]시", 48]
                    ],
                    fontSize: 11,
                    arrowColor: "#FFD974"
                },
