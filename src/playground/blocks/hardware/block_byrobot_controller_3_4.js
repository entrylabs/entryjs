...
Entry.byrobot_controller_3_4.getBlocks = function()
{
    return {
        ...
        byrobot_controller_3_controller_light_manual_single_off:
        {
            ...
            isNotFor: ['byrobot_controller_3_4'],
            func: function(sprite, script) {
                return Entry.byrobot_controller_3_4.setLightManual(script, 0x20, 0xff, 0);
            },
        },
        ...
        byrobot_controller_3_controller_light_color_preset:
        {
            ...
            func: function(sprite, script) {
                ...
                return Entry.byrobot_controller_3_4.setLightModeColor(script, 0x20, mode, interval, red, green, blue);
            },
        },
        ...
        byrobot_controller_3_controller_light_manual_single_input:
        {
            ...
            func: function(sprite, script) {
                ...
                return Entry.byrobot_controller_3_4.setLightManual(script, 0x20, flags, brightness);
            },
        },
        ...
        byrobot_controller_3_controller_buzzer_off:
        {
            ...
            isNotFor: ['byrobot_controller_3_4'],
            func: function(sprite, script) {
                return Entry.byrobot_controller_3_4.setBuzzerStop(script);
            },
        },
        ...
        byrobot_controller_3_controller_buzzer_scale:
        {
            ...
            func: function(sprite, script) {
                ...
                if (scale == -1)
                    return Entry.byrobot_controller_3_4.setBuzzerMute(script, 60000, false, true);
                else
                    return Entry.byrobot_controller_3_4.setBuzzerScale(script, octave, scale, 60000, false, true);
            },
        },
        ...
        byrobot_controller_3_controller_buzzer_scale_delay:
        {
            ...
            func: function(sprite, script) {
                ...
                if (scale == -1)
                    return Entry.byrobot_controller_3_4.setBuzzerMute(script, time, true, true);
                else
                    return Entry.byrobot_controller_3_4.setBuzzerScale(script, octave, scale, time, true, true);
            },
        },
        ...
        byrobot_controller_3_controller_buzzer_scale_reserve:
        {
            ...
            func: function(sprite, script) {
                ...
                if (scale == -1)
                    return Entry.byrobot_controller_3_4.setBuzzerMute(script, time, false, false);
                else
                    return Entry.byrobot_controller_3_4.setBuzzerScale(script, octave, scale, time, false, false);
            },
        },
        ...
        byrobot_controller_3_controller_buzzer_hz:
        {
            ...
            func: function(sprite, script) {
                ...
                return Entry.byrobot_controller_3_4.setBuzzerHz(script, hz, 60000, false, true);
            },
        },
        ...
        byrobot_controller_3_controller_buzzer_hz_delay:
        {
            ...
            func: function(sprite, script) {
                var hz = parseInt(script.getNumberValue('HZ', script));
                var time = parseInt(script.getNumberValue('TIME') * 1000);
                return Entry.byrobot_controller_3_4.setBuzzerHz(script, hz, time, true, true);
            },
        },
        ...
        byrobot_controller_3_controller_buzzer_hz_reserve:
        {
            ...
            func: function(sprite, script) {
                var hz = parseInt(script.getNumberValue('HZ', script));
                var time = parseInt(script.getNumberValue('TIME') * 1000);
                return Entry.byrobot_controller_3_4.setBuzzerHz(script, hz, time, false, false);
            },
        },
    };
};
