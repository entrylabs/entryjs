    ...
    return {
        ko: {
            template: {
                ...
                robotis_Practice_securitybot_hi: "보안 로봇 위아래로 흔들기 %1",
                robotis_Practice_securitybot_alert: "보안 로봇 좌우로 흔들기 %1",

                robotis_Practice_petbot_happy: "반려 로봇 웃음 %1",
                robotis_Practice_petbot_sad: "반려 로봇 화남 %1",
                ...
                // 인공지능 카메라 값 블록
                robotis_Practice_huskylens_connection_status: "인공지능 카메라: %1이면",
                robotis_Practice_huskylens_if_detected: "인공지능 카메라: %1 이/가 표시되면",

                robotis_Practice_huskylens_block_value_closest_to_center: "인공지능 카메라: 화면 중앙과 가까운 %1의 %2",
                robotis_Practice_huskylens_arrow_value_closest_to_center: "인공지능 카메라: 화면 중앙과 가까운 화살표의 %1",
                robotis_Practice_huskylens_number_of_learned_id: "인공지능 카메라: 학습한 번호의 갯수",
                robotis_Practice_huskylens_block_value_of_id: "인공지능 카메라: 감지된 번호가 %1인 %2의 %3",
                robotis_Practice_huskylens_arrow_value_of_id: "인공지능 카메라: 감지된 번호가 %1인 화살표의 %2",

                robotis_Practice_huskylens_if_learned_id: "인공지능 카메라: 번호가 %1인 데이터를 학습하였으면",
                robotis_Practice_huskylens_if_detected_id_type: "인공지능 카메라: 번호가 %1인 %2데이터를 인식하였으면",
                

                // 인공지능 카메라 제어
                robotis_Practice_huskylens_set_mode: "인공지능 카메라: 모드를 %1(으)로 설정 %2",
                robotis_Practice_huskylens_print_custom_text: "인공지능 카메라: 화면 위치 (%1,%2)에 %3를 보여주기%4",
                robotis_Practice_huskylens_clear_custom_text: "인공지능 카메라: 화면의 글 지우기 %1",
            },
            Helper: {
                // 주행 제어
                ...
                robotis_Practice_huskylens_block_value_closest_to_center: "인공지능 카메라 화면 중앙과 가장 가까운 사각형의 X좌표/Y좌표/너비/높이/학습번호",
                robotis_Practice_huskylens_arrow_value_closest_to_center: "인공지능 카메라 화면 중앙과 가장 가까운 화살표의 시작점X좌표/시작점Y좌표/끝점X좌표/끝점Y좌표/학습번호",
            ...
            Blocks: {
                ...
                robotis_huskylens_center_leared_id: "학습번호",
