...
Entry.SmartBoard = {
    ...
    monitorTemplate: {
        listPorts: {
            ...
            a0: {
                name: Lang.Hw.port_en + ' 5번 ' + Lang.Hw.sensor,
                type: 'input',
                pos: { x: 0, y: 0 },
            },
            a1: {
                name: Lang.Hw.port_en + ' 6번 ' + Lang.Hw.sensor,
                type: 'input',
                pos: { x: 0, y: 0 },
            },
            a6: {
                name: Lang.Hw.port_en + ' 7번 ' + Lang.Hw.sensor,
                type: 'input',
                pos: { x: 0, y: 0 },
            },
            a7: {
                name: Lang.Hw.port_en + ' 8번 ' + Lang.Hw.sensor,
                type: 'input',
                pos: { x: 0, y: 0 },
            },
        },
