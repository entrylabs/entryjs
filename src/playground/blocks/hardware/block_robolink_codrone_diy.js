    ...
    return {
        ko: {
            ...
            Blocks: {
                ...
                monitor_motion_accel_x                          : '가속도 X',
                monitor_motion_accel_y                          : '가속도 Y',
                monitor_motion_accel_z                          : '가속도 Z',
                monitor_motion_gyro_roll                        : '자이로 Roll',
                monitor_motion_gyro_pitch                       : '자이로 Pitch',
                monitor_motion_gyro_yaw                         : '자이로 Yaw',
                monitor_motion_angle_roll                       : '자세 Roll',
                monitor_motion_angle_pitch                      : '자세 Pitch',
                monitor_motion_angle_yaw                        : '자세 Yaw',
        ...
        en: {
            Blocks: {
                ...
                monitor_motion_accel_x                           : 'Accel X',
                monitor_motion_accel_y                           : 'Accel Y',
                monitor_motion_accel_z                           : 'Accel Z',
                monitor_motion_gyro_roll                         : 'Gyro Roll',
                monitor_motion_gyro_pitch                        : 'Gyro Pitch',
                monitor_motion_gyro_yaw                          : 'Gyro Yaw',
                monitor_motion_angle_roll                        : 'Roll',
                monitor_motion_angle_pitch                       : 'Pitch',
                monitor_motion_angle_yaw                         : 'Yaw',
                ...
                drone_position_x                        : 'Position X',
                drone_position_y                        : 'Position Y',
                drone_position_z                        : 'Position Z',
    ...
    return {
        ...
        */
        ...
        listPorts: {
            ...
            motion_accelX                : { name: Lang.Blocks.monitor_motion_accel_x, type: 'input', pos: { x: 0, y: 0 } },
            motion_accelY                : { name: Lang.Blocks.monitor_motion_accel_y, type: 'input', pos: { x: 0, y: 0 } },
            motion_accelZ                : { name: Lang.Blocks.monitor_motion_accel_z, type: 'input', pos: { x: 0, y: 0 } },
            motion_gyroRoll              : { name: Lang.Blocks.monitor_motion_gyro_roll, type: 'input', pos: { x: 0, y: 0 } },
            motion_gyroPitch             : { name: Lang.Blocks.monitor_motion_gyro_pitch, type: 'input', pos: { x: 0, y: 0 } },
            motion_gyroYaw               : { name: Lang.Blocks.monitor_motion_gyro_yaw, type: 'input', pos: { x: 0, y: 0 } },
            motion_angleRoll             : { name: Lang.Blocks.monitor_motion_angle_roll, type: 'input', pos: { x: 0, y: 0 } },
            motion_anglePitch            : { name: Lang.Blocks.monitor_motion_angle_pitch, type: 'input', pos: { x: 0, y: 0 } },
            motion_angleYaw              : { name: Lang.Blocks.monitor_motion_angle_yaw, type: 'input', pos: { x: 0, y: 0 } },
