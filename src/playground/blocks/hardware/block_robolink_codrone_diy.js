    ...
    return {
        ko: {
            ...
            template: {
                ...
                robolink_codrone_diy_controller_display_clear            : '지우기 x %1, y %2, 너비 %3, 높이 %4 %5 %6',
                robolink_codrone_diy_controller_display_clear_all        : '화면 전체 지우기%1 %2',
                robolink_codrone_diy_controller_display_draw_circle      : '원 x %1, y %2, 반지름 %3 %4 %5 %6',
                robolink_codrone_diy_controller_display_draw_line        : '선 x1 %1, y1 %2, x2 %3, y2 %4 %5 %6 %7',
                robolink_codrone_diy_controller_display_draw_point       : '점 그리기 x %1, y %2 %3 %4',
                robolink_codrone_diy_controller_display_draw_rect        : '사각형 x %1, y %2, 너비 %3, 높이 %4 %5 %6 %7 %8',
                robolink_codrone_diy_controller_display_draw_string      : '문자열 x %1, y %2 %3 %4 입력 %5 %6',
                robolink_codrone_diy_controller_display_draw_string_align: '문자열 정렬 x1 %1, x2 %2, y %3 %4 %5 %6 입력 %7 %8',
                ...
                robolink_codrone_diy_controller_light_color_input        : '조종기 LED R %1, G %2, B %3 %4 %5 %6',
                robolink_codrone_diy_controller_light_color_select       : '조종기 LED %1 %2 %3 %4',
                ...
                robolink_codrone_diy_controller_value_joystick           : '%1',
                robolink_codrone_diy_controller_vibrator_delay           : '진동 %1초 켜기, %2초 끄기를 %3초 실행 %4',
                ...
                robolink_codrone_diy_drone_control_headless              : 'Headless mode %1 %2',
                ...
                robolink_codrone_diy_drone_information                   : '%1',
                robolink_codrone_diy_drone_sensor                        : '%1',
                robolink_codrone_diy_drone_value_position                : '%1',
                robolink_codrone_diy_drone_value_sensor                  : '%1',
                robolink_codrone_diy_drone_value_etc                     : '%1',
            },
            ...
            Helper: {
                ...
                robolink_codrone_diy_controller_display_clear            : "<br>조종기 LCD 화면의 선택한 영역을 지웁니다. x, y 좌표값과 너비, 높이를 지정합니다. 좌표(x, y) = (가로, 세로) 화면상의 위치입니다. 사용 가능한 값의 범위는 x값과 너비는 (0~128), y값과 높이는 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                robolink_codrone_diy_controller_display_clear_all        : "<br>조종기 LCD 화면 전체를 지웁니다. 흰색/검은색 중에서 원하는 색을 선택할 수 있습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                robolink_codrone_diy_controller_display_draw_circle      : "<br>조종기 LCD 화면에서 지정한 위치에 원을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>x, y 좌표값과 반지름을 지정합니다. 원의 중심 = (x, y),<br>반지름은 원의 크기를 결정합니다.<br><br>★☆사용 가능한 값의 범위는 x값은 (-50~178), y값은 (-50~114), 반지름은 (1~200)입니다.☆★<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                robolink_codrone_diy_controller_display_draw_line        : "<br>조종기 LCD 화면에서 지정한 위치에 선을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>시작점 = (x1, y1), 끝나는점 = (x2, y2)<br>선 그리기는 시작점과 끝나는점을 이어주는 기능입니다.<br>사용 가능한 값의 범위는 x값은 (0~128), y값은 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                robolink_codrone_diy_controller_display_draw_point       : "<br>조종기 LCD 화면에서 지정한 위치에 점을 찍습니다. 흰색/검은색 중에서 원하는 색을 선택할 수 있습니다. x, y 좌표값으로 지정합니다. 좌표(x, y) = (가로, 세로) 화면상의 위치입니다. 사용 가능한 값의 범위는 x값은 (0~128), y값은 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                robolink_codrone_diy_controller_display_draw_rect        : "<br>조종기 LCD 화면에서 지정한 위치에 사각형을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>x, y 좌표값과 너비, 높이를 지정합니다. 시작점 = (x, y), 사용 가능한 값의 범위는 x값과 너비는 (0~128), y값과 높이는 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                robolink_codrone_diy_controller_display_draw_string      : "<br>조종기 LCD 화면에서 지정한 위치에 문자열을 씁니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>글자 입력은 영문자 알파벳 대문자, 소문자와 숫자, 공백(space), 특수문자만 가능합니다.(한글은 아직 지원되지 않습니다.)<br>x, y 좌표값과 글자 크기, 색을 지정합니다. 시작점 = (x, y), 사용 가능한 값의 범위는 x값은 (0~120), y값과 높이는 (0~60)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                robolink_codrone_diy_controller_display_draw_string_align: "<br>조종기 LCD 화면에서 지정한 위치에 문자열을 정렬하여 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>글자 입력은 영문자 알파벳 대문자, 소문자와 숫자, 공백(space), 특수문자만 가능합니다.(한글은 아직 지원되지 않습니다.)<br>x, y 좌표값과 정렬 방향, 글자 크기, 색을 지정합니다. 시작점 = (x1, y), 끝나는점 = (x2, y), 사용 가능한 값의 범위는 x값은 (0~128), y값은 (0~60)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                ...
                robolink_codrone_diy_controller_light_color_input        : "<br>빛의 삼원색인 Red, Green, Blue 값을 지정하여 조종기 LED의 색상을 원하는대로 만들 수 있습니다.<br>10진수(0 ~ 255) 값을 사용합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
                robolink_codrone_diy_controller_light_color_select       : "<br>RGB 색지정 블록을 이용해서 만들 수 있는<br> 조종기 LED 예시입니다.<br>RGB 색지정 블록을 이용해서 멋진 색깔을<br> 다양하게 만들어보세요.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
                robolink_codrone_diy_controller_light_color_preset       : "<br>조종기 LED를 조작하는데 사용합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
                robolink_codrone_diy_controller_light_manual_single_input: "<br>조종기 LED를 조작하는데 사용합니다.<br>10진수(0 ~ 255) 또는 16진수(0x00 ~ 0xFF) 값을 사용할 수 있습니다.<br>각각의 비트는 LED를 선택하는 스위치 역할을 합니다.<br>밝기 값은 0 ~ 255 사이의 값을 사용할 수 있습니다.<br>값이 커질수록 더 밝아집니다. <br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
                robolink_codrone_diy_controller_light_manual_single_off  : "<br>조종기의 모든 LED를 끕니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED끄기</font>",
                robolink_codrone_diy_controller_value_button             : "<br>조종기에서 눌러진 버튼과 관련된 이벤트를 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#버튼</font>",
                robolink_codrone_diy_controller_value_joystick           : "<br>조종기의 조이스틱과 관련된 입력 값을 반환합니다. 각 축의 범위는 -100 ~ 100 입니다.<br><br>조이스틱 방향은 가로x세로 = 3x3 = 총9방향입니다.<br>위(왼쪽=17, 가운데=18, 오른쪽=20)<br>중간(왼쪽=33, 센터=34, 오른쪽=36)<br>아래(왼쪽=65, 가운데=66, 오른쪽=68)<br>기본값은 센터=34입니다.<br><br>조이스틱 이벤트는 값이 있을때 2, 없으면 0, 진입 1, 벗어남 3입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
                robolink_codrone_diy_controller_vibrator_delay           : "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 반복합니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
                robolink_codrone_diy_controller_vibrator_off             : "<br>진동을 끕니다. 예약된 진동이 있다면 모두 삭제합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동끄기</font>",
                robolink_codrone_diy_controller_vibrator_on_delay        : "<br>진동을 지정한 시간동안 켭니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
                robolink_codrone_diy_controller_vibrator_on_reserve      : "<br>진동을 지정한 시간동안 켜는 것을 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
                robolink_codrone_diy_controller_vibrator_reserve         : "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 반복하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
                robolink_codrone_diy_drone_control_headless              : "<br>드론 좌표 기준을 변경합니다. Headless mode 선택을 on으로 하면 이륙 시와 '방향초기화'를 했을 때 드론이 바라보는 방향을 기준으로 앞뒤좌우가 고정됩니다. 이 때에는 Yaw를 조작하여 드론이 다른 방향을 보게 하여도 처음 지정한 방향을 기준으로 앞뒤좌우로 움직입니다. 사용자가 바라보는 방향과 드론의 기준 방향이 같을 때 조작하기 편리한 장점이 있습니다.<br>Headless mode를 off로 선택하면 현재 드론이 바라보는 방향을 기준으로 앞뒤좌우가 결정됩니다. 드론의 움직임에 따라 앞뒤좌우가 계속 바뀌기 때문에 익숙해지기 전까지는 사용하기 어려울 수 있습니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#좌표기준</font>",
                ...
                robolink_codrone_diy_drone_value_etc                     : "<br>드론 설정과 관련된 값들과 적외선 통신으로 받은 값을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#기타</font>",
                ...
                robolink_codrone_diy_drone_value_sensor                  : "<br>드론 거리 및 고도 센서와 관련된 값들을 반환합니다(단위:m)<br>거리 센서의 유효 측정 거리는 2m입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#센서</font> <font color='crimson'>#거리센서</font> <font color='dodgerblue'>#대기압</font>",
            },
        },
        ...
        en: {
            ...
            template: {
                ...
                robolink_codrone_diy_controller_display_clear            : 'clear controller display x:%1, y:%2, width:%3, height:%4, color:%5 %6',
                robolink_codrone_diy_controller_display_clear_all        : 'clear controller display with %1 color %2',
                robolink_codrone_diy_controller_display_draw_circle      : 'draw a circle x:%1, y:%2, radius:%3, %4, %5, %6',
                robolink_codrone_diy_controller_display_draw_line        : 'draw a line x1:%1, y1:%2, x2:%3, y2:%4, %5, %6 %7',
                robolink_codrone_diy_controller_display_draw_point       : 'draw a point x:%1, y:%2, color:%3 %4',
                robolink_codrone_diy_controller_display_draw_rect        : 'draw a rectangle x:%1, y:%2, width:%3, height:%4, %5, %6, %7 %8',
                robolink_codrone_diy_controller_display_draw_string      : 'draw a string x:%1, y:%2, font size:%3, %4, input:%5, %6',
                robolink_codrone_diy_controller_display_draw_string_align: 'draw aligned string x1:%1, x2:%2, y:%3, align:%4, font size:%5, %6, input:%7, %8',
                ...
                robolink_codrone_diy_controller_light_color_input        : 'Controller LED R %1, G %2, B %3 %4 %5 %6',
                robolink_codrone_diy_controller_light_color_select       : 'Controller LED Preset %1 %2 %3 %4',
                robolink_codrone_diy_controller_light_color_preset       : 'Controller LED %1 %2 %3',
                ...
                robolink_codrone_diy_controller_vibrator_delay           : 'Vibrator %1 sec On, %2 sec Off for %3 sec run %4',
                robolink_codrone_diy_controller_vibrator_on_delay        : 'Vibrator %1 sec on %2',
                robolink_codrone_diy_controller_vibrator_on_reserve      : 'Vibrator %1 sec reserve %2',
                robolink_codrone_diy_controller_vibrator_reserve         : 'Vibrator %1 sec On, %2 sec Off for %3 sec reserve %4',
                robolink_codrone_diy_drone_control_headless              : 'Headless mode %1 %2',
            ...
            Helper: {
                ...
                robolink_codrone_diy_controller_display_clear            : '',
                robolink_codrone_diy_controller_display_clear_all        : '',
                robolink_codrone_diy_controller_display_draw_circle      : '',
                robolink_codrone_diy_controller_display_draw_line        : '',
                robolink_codrone_diy_controller_display_draw_point       : '',
                robolink_codrone_diy_controller_display_draw_rect        : '',
                robolink_codrone_diy_controller_display_draw_string      : '',
                robolink_codrone_diy_controller_display_draw_string_align: '',
                robolink_codrone_diy_controller_if_button_press          : '',
                robolink_codrone_diy_controller_if_joystick_direction    : '',
                robolink_codrone_diy_controller_light_color_input        : '',
                robolink_codrone_diy_controller_light_color_select       : '',
                robolink_codrone_diy_controller_light_color_preset       : '',
                ...
                robolink_codrone_diy_controller_value_joystick           : '',
                robolink_codrone_diy_controller_vibrator_delay           : '',
                robolink_codrone_diy_controller_vibrator_off             : '',
                robolink_codrone_diy_controller_vibrator_on_delay        : '',
                robolink_codrone_diy_controller_vibrator_on_reserve      : '',
                robolink_codrone_diy_controller_vibrator_reserve         : '',
...
Entry.robolink_codrone_diy.getBlocks = function () {
    return {
        ...
        robolink_codrone_diy_drone_value_sensor: {
            ...
            def   : {
                params: [null],
                type  : 'robolink_codrone_diy_drone_value_sensor',
            },
            paramsKeyMap: {
                DEVICE: 0,
            },
        ...
        robolink_codrone_diy_drone_value_etc: {
            ...
            def   : {
                params: [null],
                type  : 'robolink_codrone_diy_drone_value_etc',
            },
            paramsKeyMap: {
                DEVICE: 0,
            },
        ...
        robolink_codrone_diy_controller_value_joystick: {
            ...
            def   : {
                params: [null],
                type  : 'robolink_codrone_diy_controller_value_joystick',
            },
            paramsKeyMap: {
                DEVICE: 0,
            },
        ...
        robolink_codrone_diy_controller_light_manual_single_off: {
            ...
            def       : {
                params: [null],
                type  : 'robolink_codrone_diy_controller_light_manual_single_off',
            },
            paramsKeyMap: {},
        ...
        robolink_codrone_diy_controller_light_color_preset: {
            ...
            def   : {
                ...
                type  : 'robolink_codrone_diy_controller_light_color_preset',
            },
            paramsKeyMap: {
                COLOR     : 0,
                BRIGHTNESS: 1,
        ...
        robolink_codrone_diy_controller_light_manual_single_input: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_light_manual_single_input',
            },
            paramsKeyMap: {
                FLAGS     : 0,
                BRIGHTNESS: 1,
        ...
        robolink_codrone_diy_controller_light_color_input: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_light_color_input',
            },
            paramsKeyMap: {
                RED     : 0,
                GREEN   : 1,
        ...
        robolink_codrone_diy_controller_light_color_select: {
            ...
            def   : {
                ...
                type  : 'robolink_codrone_diy_controller_light_color_select',
            },
            paramsKeyMap: {
                COLOR   : 0,
                MODE    : 1,
        ...
        robolink_codrone_diy_controller_display_clear_all: {
            ...
            def   : {
                params: [null, null],
                type  : 'robolink_codrone_diy_controller_display_clear_all',
            },
            paramsKeyMap: {
                PIXEL: 0,
            },
        ...
        robolink_codrone_diy_controller_display_clear: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_display_clear',
            },
            paramsKeyMap: {
                X     : 0,
                Y     : 1,
        ...
        robolink_codrone_diy_controller_display_draw_point: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_display_draw_point',
            },
            paramsKeyMap: {
                X    : 0,
                Y    : 1,
        ...
        robolink_codrone_diy_controller_display_draw_line: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_display_draw_line',
            },
            paramsKeyMap: {
                X1   : 0,
                Y1   : 1,
        ...
        robolink_codrone_diy_controller_display_draw_rect: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_display_draw_rect',
            },
            paramsKeyMap: {
                X       : 0,
                Y       : 1,
        ...
        robolink_codrone_diy_controller_display_draw_circle: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_display_draw_circle',
            },
            paramsKeyMap: {
                X       : 0,
                Y       : 1,
        ...
        robolink_codrone_diy_controller_display_draw_string: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_display_draw_string',
            },
            paramsKeyMap: {
                X     : 0,
                Y     : 1,
        ...
        robolink_codrone_diy_controller_display_draw_string_align: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_display_draw_string_align',
            },
            paramsKeyMap: {
                XSTART: 0,
                XEND  : 1,
        ...
        robolink_codrone_diy_controller_vibrator_off: {
            ...
            def       : {
                params: [null],
                type  : 'robolink_codrone_diy_controller_vibrator_off',
            },
            paramsKeyMap: {},
            class       : 'vibrator',
            isNotFor    : ['robolink_codrone_diy'],
        ...
        robolink_codrone_diy_controller_vibrator_on_delay: {
            ...
            def   : {
                ...
                type  : 'robolink_codrone_diy_controller_vibrator_on_delay',
            },
            paramsKeyMap: {
                TIMEON: 0,
            },
        ...
        robolink_codrone_diy_controller_vibrator_on_reserve: {
            ...
            def   : {
                params: [{ type: 'text', params: ['1'] }, null],
                type  : 'robolink_codrone_diy_controller_vibrator_on_reserve',
            },
            paramsKeyMap: {
                TIMEON: 0,
            },
        ...
        robolink_codrone_diy_controller_vibrator_delay: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_vibrator_delay',
            },
            paramsKeyMap: {
                TIMEON : 0,
                TIMEOFF: 1,
        ...
        robolink_codrone_diy_controller_vibrator_reserve: {
            ...
            def   : {
                ...
                type: 'robolink_codrone_diy_controller_vibrator_reserve',
            },
            paramsKeyMap: {
                TIMEON : 0,
                TIMEOFF: 1,
