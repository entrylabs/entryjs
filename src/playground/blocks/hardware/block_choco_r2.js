...
Entry.Choco_R2.setLanguage = function() {
    return {
        ko: {
            template: {
...
Entry.Choco_R2.blockMenuBlocks = [
    //choco
    'choco_move_forward',
    'choco_move_backward',
    'choco_turn_left',
...
Entry.Choco_R2.getBlocks = function() {
    return {
        choco_move_forward: {
            ...
            func: function(sprite, script) {
                ...
                if (!script.is_started) {
                    ...
                    const msgId = Entry.Choco_R2.getHashKey();
                    script.msg_id = msgId;
