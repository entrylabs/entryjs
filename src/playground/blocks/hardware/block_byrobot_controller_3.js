    ...
    return {
        ko: {
            ...
            template: {
                ...
                byrobot_controller_3_controller_display_clear        : '지우기 x %1, y %2, 너비 %3, 높이 %4 %5 %6',
                byrobot_controller_3_controller_display_clear_all    : '조종기 화면 전체 지우기%1 %2',
                byrobot_controller_3_controller_display_draw_circle  : '원 x %1, y %2, 반지름 %3 %4 %5 %6',
                byrobot_controller_3_controller_display_draw_line    : '선 x1 %1, y1 %2, x2 %3, y2 %4 %5 %6 %7',
                byrobot_controller_3_controller_display_draw_point   : '점 그리기 x %1, y %2 %3 %4',
                byrobot_controller_3_controller_display_draw_rect    : '사각형 x %1, y %2, 너비 %3, 높이 %4 %5 %6 %7 %8',
                byrobot_controller_3_controller_display_draw_string  : '문자열 x %1, y %2 %3 %4 입력 %5 %6',
                byrobot_controller_3_controller_display_draw_string_align: '문자열 정렬 x1 %1, x2 %2, y %3 %4 %5 %6 입력 %7 %8',
                byrobot_controller_3_controller_display_invert       : '색반전 x %1, y %2, 너비 %3, 높이 %4 %5',
                ...
                byrobot_controller_3_controller_vibrator_delay       : '진동 %1 초 켜기, %2 초 끄기를 %3 초 실행 %4',
                byrobot_controller_3_controller_vibrator_off         : '진동 끄기 %1',
                byrobot_controller_3_controller_vibrator_on_delay    : '진동 %1 초 켜기 %2',
                byrobot_controller_3_controller_vibrator_on_reserve  : '진동 %1 초 예약 %2',
                byrobot_controller_3_controller_vibrator_reserve     : '진동 %1 초 켜기, %2 초 끄기를 %3 초 예약 %4',
            },
            ...
            Helper: {
                ...
                byrobot_controller_3_controller_display_clear        : "<br>조종기 OLED 화면의 선택한 영역을 지웁니다. x, y 좌표값과 너비, 높이를 지정합니다. 좌표(x, y) = (가로, 세로) 화면상의 위치입니다. 사용 가능한 값의 범위는 x값과 너비는 (0~128), y값과 높이는 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                byrobot_controller_3_controller_display_clear_all    : "<br>조종기 OLED 화면 전체를 지웁니다. 흰색/검은색 중에서 원하는 색을 선택할 수 있습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                byrobot_controller_3_controller_display_draw_circle  : "<br>조종기 OLED 화면에서 지정한 위치에 원을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>x, y 좌표값과 반지름을 지정합니다. 원의 중심 = (x, y),<br>반지름은 원의 크기를 결정합니다.<br><br>★☆사용 가능한 값의 범위는 x값은 (-50~178), y값은 (-50~114), 반지름은 (1~200)입니다.☆★<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                byrobot_controller_3_controller_display_draw_line    : "<br>조종기 OLED 화면에서 지정한 위치에 선을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>시작점 = (x1, y1), 끝나는점 = (x2, y2)<br>선 그리기는 시작점과 끝나는점을 이어주는 기능입니다.<br>사용 가능한 값의 범위는 x값은 (0~128), y값은 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                byrobot_controller_3_controller_display_draw_point   : "<br>조종기 OLED 화면에서 지정한 위치에 점을 찍습니다. 흰색/검은색 중에서 원하는 색을 선택할 수 있습니다. x, y 좌표값으로 지정합니다. 좌표(x, y) = (가로, 세로) 화면상의 위치입니다. 사용 가능한 값의 범위는 x값은 (0~128), y값은 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                byrobot_controller_3_controller_display_draw_rect    : "<br>조종기 OLED 화면에서 지정한 위치에 사각형을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>x, y 좌표값과 너비, 높이를 지정합니다. 시작점 = (x, y), 사용 가능한 값의 범위는 x값과 너비는 (0~128), y값과 높이는 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                byrobot_controller_3_controller_display_draw_string  : "<br>조종기 OLED 화면에서 지정한 위치에 문자열을 씁니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>글자 입력은 영문자 알파벳 대문자, 소문자와 숫자, 공백(space), 특수문자만 가능합니다.(한글은 아직 지원되지 않습니다.)<br>x, y 좌표값과 글자 크기, 색을 지정합니다. 시작점 = (x, y), 사용 가능한 값의 범위는 x값은 (0~120), y값과 높이는 (0~60)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                ...
                byrobot_controller_3_controller_display_invert       : "<br>조종기 OLED 화면에서 선택한 영역의 색을 반전시킵니다. x, y 좌표값과 너비, 높이를 지정합니다. 좌표(x, y) = (가로, 세로) 화면상의 위치입니다. 사용 가능한 값의 범위는 x값과 너비는 (0~128), y값과 높이는 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
                ...
                byrobot_controller_3_controller_vibrator_delay       : "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 반복합니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
                byrobot_controller_3_controller_vibrator_off         : "<br>진동을 끕니다. 예약된 진동이 있다면 모두 삭제합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동끄기</font>",
                byrobot_controller_3_controller_vibrator_on_delay    : "<br>진동을 지정한 시간동안 켭니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
                byrobot_controller_3_controller_vibrator_on_reserve  : "<br>진동을 지정한 시간동안 켜는 것을 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
                byrobot_controller_3_controller_vibrator_reserve     : "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 반복하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
            },
        },
        ...
        en: {
            ...
            template: {
                byrobot_controller_3_controller_buzzer_hz: 'play Buzzer %1 Hz sound %2',
                byrobot_controller_3_controller_buzzer_hz_delay: 'play Buzzer %1 Hz sound for %2 second %3',
                byrobot_controller_3_controller_buzzer_hz_reserve: 'reserve to play Buzzer %1 Hz for %2 second %3',
                ...
                byrobot_controller_3_controller_display_clear: 'clear controller display x:%1, y:%2, width:%3, height:%4, color:%5 %6',
                byrobot_controller_3_controller_display_clear_all: 'clear controller display with %1 color %2',
                byrobot_controller_3_controller_display_draw_circle: 'draw a circle x:%1, y:%2, radius:%3, %4, %5, %6',
                byrobot_controller_3_controller_display_draw_line: 'draw a line x1:%1, y1:%2, x2:%3, y2:%4, %5, %6 %7',
                byrobot_controller_3_controller_display_draw_point: 'draw a point in controller display  x:%1, y:%2, color:%3 %4',
                byrobot_controller_3_controller_display_draw_rect: 'draw a rectangle in controller display x:%1, y:%2, width:%3, height:%4, %5, %6, %7 %8',
                byrobot_controller_3_controller_display_draw_string: 'draw a string in controller display x:%1, y:%2, font size:%3, %4, input:%5, %6',
                byrobot_controller_3_controller_display_draw_string_align: 'draw aligned string in controller display x1:%1, x2:%2, y:%3, align:%4, font size:%5, %6, input:%7, %8',
                byrobot_controller_3_controller_display_invert: 'invert controller display x:%1, y:%2, width:%3, height:%4 %5',
                ...
                byrobot_controller_3_controller_light_color_input: 'Controller LED R %1, G %2, B %3 %4 %5 %6',
                byrobot_controller_3_controller_light_color_select: 'Controller LED Preset %1 %2 %3 %4',
                byrobot_controller_3_controller_light_color_preset: 'Controller LED %1 %2 %3',
                byrobot_controller_3_controller_light_manual_single_input: 'Controller LED %1 Lightness %2 %3',
                byrobot_controller_3_controller_light_manual_single_off: 'Controller LED Off %1',
                byrobot_controller_3_controller_value_button: '%1',
                byrobot_controller_3_controller_value_joystick: '%1',
                byrobot_controller_3_controller_vibrator_off: 'Vibrator Off %1',
                byrobot_controller_3_controller_vibrator_delay: 'Vibrator %1 sec On, %2 sec Off for %3 sec run %4',
                byrobot_controller_3_controller_vibrator_on_delay: 'Vibrator %1 sec on %2',
                byrobot_controller_3_controller_vibrator_on_reserve: 'Vibrator %1 sec reserve %2',
                byrobot_controller_3_controller_vibrator_reserve: 'Vibrator %1 sec On, %2 sec Off for %3 sec reserve %4',
            },
    ...
    return {
        ...
        byrobot_controller_3_controller_light_color_input: {
            ...
            def: {
                ...
                type: 'byrobot_controller_3_controller_light_color_input',
            },
            paramsKeyMap: {
                RED: 0,
                GREEN: 1,
