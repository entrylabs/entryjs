...
Entry.HyACT_Xylobot.setLanguage = function() {
    return {
        ...
        en: {
            template: {
                hyact_xylobot_list_aixs_1: 'First aixs',
                hyact_xylobot_list_aixs_2: 'Second aixs',
                hyact_xylobot_list_aixs_3: 'Third aixs',
                hyact_xylobot_list_aixs_all: 'All aixs',
                ...
                hyact_xylobot_set_position_many_block: 'Target position setting to first aixs : %1º(degree)  second axis : %2º(degree)  third aixs : %3º(degree) %4',
