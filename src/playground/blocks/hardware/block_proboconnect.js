    ...
    return {
        ...
        connect_infinite_setting: {
            ...
            func: function(sprite, script) {
                ...
                Entry.ProboConnect.Infinite_Start[port] = Entry.ProboConnect.Infinite_Buff[port]-value;
        ...
        connect_infinite_transform_input: {
            ...
            func: function(sprite, script) {
                ...
                switch (select) {
                    ...
                    case 4:
                        return Number((360/255) * value).toFixed(0);
                    default:
                        return (
                            value -
        ...
        connect_rgbled_flashing_output: {
            ...
            func: function(sprite, script) {
                const port = script.getStringField('PORT', script);
                const color = script.getNumberValue('COLOR', script);
                const sec = script.getNumberValue('SEC', script);
                Entry.hw.sendQueue[port] = color+sec;
            },
        },
        connect_rgbled_dimming_output: {
            color: EntryStatic.colorSet.block.default.HARDWARE,
