...
Entry.ArduinoExt.setLanguage = function() {
    return {
        ko: {
            template: {
                jikko_esp_get_analog_value: '아날로그 %1 번 센서값',
                jikko_esp_get_analog_value_map: '%1 의 범위를 %2 ~ %3 에서 %4 ~ %5 로 바꾼값',
                jikko_esp_get_ultrasonic_value: '울트라소닉 Trig %1 Echo %2 센서값',
                jikko_esp_toggle_led: '디지털 %1 번 핀 %2 %3',
                jikko_esp_digital_pwm: '디지털 %1 번 핀을 %2 (으)로 정하기 %3',
                jikko_esp_set_tone: '디지털 %1 번 핀의 버저를 %2 %3 음으로 %4 초 연주하기 %5',
                jikko_esp_set_servo: '디지털 %1 번 핀의 서보모터를 %2 의 각도로 정하기 %3',
                jikko_esp_get_digital: '디지털 %1 번 센서값',
            },
        },
        en: {
            template: {
                jikko_esp_get_analog_value: 'Analog %1 Sensor value',
                jikko_esp_get_analog_value_map: 'Map Value %1 %2 ~ %3 to %4 ~ %5',
                jikko_esp_get_ultrasonic_value: 'Read ultrasonic sensor trig pin %1 echo pin %2',
                jikko_esp_toggle_led: 'Digital %1 Pin %2 %3',
                jikko_esp_digital_pwm: 'Digital %1 Pin %2 %3',
                jikko_esp_set_tone: 'Play tone pin %1 on note %2 octave %3 beat %4 %5',
                jikko_esp_set_servo: 'Set servo pin %1 angle as %2 %3',
                jikko_esp_get_digital: 'Digital %1 Sensor value',
            },
        },
    };
};
...
Entry.ArduinoExt.blockMenuBlocks = [
    ...
    'jikko_esp_get_analog_value_map',
    'jikko_esp_get_ultrasonic_value',
    'jikko_esp_get_digital',
    'jikko_esp_toggle_led',
    'jikko_esp_digital_pwm',
    'jikko_esp_set_servo',
    'jikko_esp_set_tone',
];
    ...
    return {
                        ...
                        textParams: [
                            {
                                ...
                                codeMap: 'Entry.CodeMap.Arduino.jikko_esp_analog_list[0]',
                                bgColor: EntryStatic.colorSet.block.darken.HARDWARE,
                                arrowColor: EntryStatic.colorSet.arrow.default.HARDWARE,
                            },
                        ],
                        keyOption: 'jikko_esp_analog_list',
                    },
                ],
            },
        },
        ...
        jikko_esp_get_analog_value_map: {
            ...
            def: {
                ...
                type: 'jikko_esp_get_analog_value_map',
            },
            paramsKeyMap: {
                PORT: 0,
                VALUE2: 1,
        ...
        jikko_esp_get_ultrasonic_value: {
            ...
            def: {
                ...
                type: 'jikko_esp_get_ultrasonic_value',
            },
            paramsKeyMap: {
                PORT1: 0,
                PORT2: 1,
                ...
                py: [
                    {
                        ...
                        keyOption: 'jikko_esp_tone_list',
                    },
                ],
            },
        },
        jikko_esp_tone_value: {
            color: EntryStatic.colorSet.block.default.HARDWARE,
            outerLine: EntryStatic.colorSet.block.darken.HARDWARE,
            skeleton: 'basic_string_field',
            statements: [],
            ...
            def: {
                params: [
                    {
                        type: 'jikko_esp_tone_list',
                    },
                ],
                type: 'jikko_esp_tone_value',
            },
            paramsKeyMap: {
                NOTE: 0,
            },
            ...
            syntax: {
                ...
                py: [
                    {
                        syntax: '%1',
                        keyOption: 'jikko_esp_tone_value',
                    },
                ],
            },
        },
        jikko_esp_octave_list: {
            color: EntryStatic.colorSet.block.default.HARDWARE,
            outerLine: EntryStatic.colorSet.block.darken.HARDWARE,
            skeleton: 'basic_string_field',
            statements: [],
            ...
            syntax: {
                ...
                py: [
                    {
                        syntax: '%1',
                        keyOption: 'jikko_esp_octave_list',
                    },
                ],
            },
        },
