            ...
            switch (keyCode) {
                ...
                case 46:
                    if (
                        ...
                        console.log("Entry.engine.isState()= " + Entry.engine.isState('stop'));
                        console.log("Entry.engine.isState()= " + Entry.engine.isState('start'));
                        console.log("Entry.engine.isState()= " + Entry.engine.isState);
