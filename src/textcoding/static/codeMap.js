...
(function(cc) {
    cc.Entry = {
        ...
        get_date_for_weather: [
            {
                ...
                'after_4_days': 'After_4_days',
                'after_5_days': 'After_5_days',
                'after_6_days': 'After_6_days',
            },
        ],
        ...
        get_weather_type: [
            {
                'lowest_temperature': 'the_lowest_temperature',
                'highest_temperature': 'the_highest_temperature',
                'humidity': 'humidity',
        ...
        weather_api_type: [
            {
                ...
                'finedust': 'concentration_of_fine_dust',
            },
        ],
