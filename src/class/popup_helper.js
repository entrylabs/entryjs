...
/**
 * show, if isNext, this.window.children().detach all children, else push to nextPopupList only if this.nextPopupList.length >0
 * @param {String} key
