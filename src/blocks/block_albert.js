...
/*
Blockly.Blocks.albert_set_port_to = {
  init: function() {
    this.setColour("#00979D");
    this.appendDummyInput()
...
Entry.block.albert_set_port_to = function (sprite, script) {
    var port = script.getField('PORT');
    var method = script.getField('METHOD');
};

Blockly.Blocks.albert_change_output_by = {
  init: function() {
    this.setColour("#00979D");
    this.appendDummyInput()
    .appendField(Lang.Blocks.HAMSTER_)
...
Entry.block.albert_change_output_by = function (sprite, script) {
};

Blockly.Blocks.albert_set_output_to = {
  init: function() {
    this.setColour("#00979D");
    this.appendDummyInput()
    .appendField(Lang.Blocks.HAMSTER_)
...
Entry.block.albert_set_output_to = function (sprite, script) {
};
*/
