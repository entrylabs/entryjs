...
Blockly.Blocks.sound_something = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldIcon(Entry.mediaFilePath + 'block_icon/sound_03.png', '*'));
...
Blockly.Blocks.sound_from_to_v2 = {
  init: function() {
    this.setColour("#A4D01D");
    this.appendDummyInput()
        .appendField(Lang.Blocks.SOUND_sound_from_to_1);
...
Entry.block.sound_from_to_v2 = function (sprite, script) {
    var soundId = script.getStringValue("VALUE", script);
    var sound = sprite.parent.getSound(soundId);
...
Blockly.Blocks.sound_from_to_and_wait_v2 = {
  init: function() {
    this.setColour("#A4D01D");
    this.appendDummyInput()
        .appendField(Lang.Blocks.SOUND_sound_from_to_and_wait_1);
...
Entry.block.sound_from_to_and_wait_v2 = function (sprite, script) {
    if (!script.isPlay) {
        script.isPlay = true;
        script.playState = 1;
        var soundId = script.getStringValue("VALUE", script);
